import{C as h}from"./CodeBlock-KFmJyFtG.js";import{_ as d,o as r,c as s,a as e,d as m,r as f,b as T,F as E,e as g,w as O,n as L,t as u,i as v,l as y,m as w}from"./index-DlJbsnOZ.js";import{P as R}from"./ProjectCard-M523nSQh.js";const A="/assets/calculator-C-5QCe61.png",S={name:"Calculator",components:{CodeBlock:h},data(){return{calculator:`from tkinter import *
...
if __name__ == "__main__":
    Calculator().mainloop()`}}},G={class:"container-fluid h-100 mt-0 pt-0"},F={class:"row pt-4",style:{height:"calc(100vh - var(--site-nav-height, 56px))","background-color":"#f0f2f5"}},I={class:"col-lg-7 col-sm-12"};function W(n,o,p,c,t,a){const i=f("CodeBlock");return r(),s("div",G,[e("div",F,[e("div",I,[m(i,{code:t.calculator},null,8,["code"])]),o[0]||(o[0]=e("div",{class:"col-lg-5 col-sm-12 pb-4 d-flex flex-column align-items-center",style:{"overflow-y":"auto",height:"calc(100vh - var(--site-nav-height, 56px) - 1.5rem)"}},[e("img",{src:A,class:"img-fluid",alt:"Screenshot of the resulting calculator GUI"}),e("p",{class:"mt-3"},"This code will create a grid for a calculator, as shown here.")],-1))])])}const b=d(S,[["render",W]]),N="/assets/macbethMap-DjhSotSc.png",k={name:"macbeth",components:{CodeBlock:h},data(){return{macbeth:`from turtle import Turtle
class playGame():
...
playGame()`}}},Y={class:"container-fluid h-100 mt-0 pt-0"},_={class:"row pt-4",style:{height:"calc(100vh - var(--site-nav-height, 56px))","background-color":"#f0f2f5"}},C={class:"col-lg-7 col-sm-12"};function H(n,o,p,c,t,a){const i=f("CodeBlock");return r(),s("div",Y,[e("div",_,[e("div",C,[m(i,{code:t.macbeth},null,8,["code"])]),o[0]||(o[0]=e("div",{class:"col-lg-5 col-sm-12 pb-4 d-flex flex-column align-items-center",style:{"overflow-y":"auto",height:"calc(100vh - var(--site-nav-height, 56px) - 1.5rem)"}},[e("img",{src:N,class:"img-fluid",alt:"Map of the rooms the player can navigate in the Macbeth adventure game"}),e("p",{class:"mt-3"}," This code is for a game. The goal of the game is to navigate through various rooms, collecting items as you go, and then bringing them all to the last room. Depending on the level of difficulty the user chooses, there is a map that can be drawn as well (as shown). ")],-1))])])}const D=d(k,[["render",H]]),x={name:"BullsCows",components:{CodeBlock:h},data(){return{code:`def main():
    import random
...
if __name__ == "__main__":
    gameOfSticks()`}}},V={class:"container-fluid h-100 mt-0 pt-0"},U={class:"row pt-4",style:{height:"calc(100vh - var(--site-nav-height, 56px))","background-color":"#f0f2f5"}},j={class:"col-lg-7 col-sm-12"};function q(n,o,p,c,t,a){const i=f("CodeBlock");return r(),s("div",V,[e("div",U,[e("div",j,[m(i,{code:t.code},null,8,["code"])]),o[0]||(o[0]=e("div",{class:"col-lg-5 col-sm-12 pb-4 d-flex flex-column justify-content-center align-items-center"},[e("p",null,"This code will create a game called Game of Sticks. The game is played as follows:"),e("p",null,"1. The computer asks how many sticks you would like to start with (10-100)."),e("p",null,"2. The two players then take turns reducing the number of sticks (1-3)."),e("p",null,"3. The player who takes the last stick loses.")],-1))])])}const J=d($,[["render",q]]),z={name:"Pig",components:{CodeBlock:h},data(){return{code:`totalone = 0
totaltwo = 0
while True:
    rollfirst = 0
    while True:
    ...
    if (totaltwo >= 100):
        ...
        break`}}},Q={class:"container-fluid h-100 mt-0 pt-0"},X={class:"row pt-4",style:{height:"calc(100vh - var(--site-nav-height, 56px))","background-color":"#f0f2f5"}},ee={class:"col-lg-7 col-sm-12"};function oe(n,o,p,c,t,a){const i=f("CodeBlock");return r(),s("div",Q,[e("div",X,[e("div",ee,[m(i,{code:t.code},null,8,["code"])]),o[0]||(o[0]=T('<div class="col-lg-5 col-sm-12 pb-4 d-flex flex-column justify-content-center align-items-center"><p>This code will create a game called Game of Pig. The game is played as follows:</p><p>Each turn starts with the player making the choice to play or hold.</p><p class="ms-4">If they play the player rolls a single die and looking at the results.</p><p class="ms-4 ps-4">If a 1 was rolled the player scores no points and their turn is over.</p><p class="ms-4 ps-4"> If any other number is rolled the player adds the number rolled to the player&#39;s turn total. </p><p class="ms-4"> If they hold their turn points are added to their score and it becomes the opponent&#39;s turn. </p></div>',1))])])}const te=d(z,[["render",oe]]),ie="/assets/turtleGraphics-C3QNb8Io.png",ne={name:"Turtle",components:{CodeBlock:h},data(){return{code:`from turtle import Turtle
def main():
    t = Turtle()
    t.pensize(2)
    roof(t)
...
if __name__ == "__main__":
    main()`}}},re={class:"container-fluid h-100 mt-0 pt-0"},se={class:"row pt-4",style:{height:"calc(100vh - var(--site-nav-height, 56px))","background-color":"#f0f2f5"}},ae={class:"col-lg-7 col-sm-12"};function le(n,o,p,c,t,a){const i=f("CodeBlock");return r(),s("div",re,[e("div",se,[e("div",ae,[m(i,{code:t.code},null,8,["code"])]),o[0]||(o[0]=e("div",{class:"col-lg-5 col-sm-12 pb-4 d-flex flex-column align-items-center",style:{"overflow-y":"auto",height:"calc(100vh - var(--site-nav-height, 56px) - 1.5rem)"}},[e("img",{src:ie,class:"img-fluid",alt:"Generated picture from the Turtle Graphics program"}),e("p",{class:"mt-3"},"This code will create a picture (as shown) using Turtle Graphics.")],-1))])])}const de=d(ne,[["render",le]]),me="/assets/pygame-C5S-2IfS.png",fe={name:"Pygame",components:{CodeBlock:h},data(){return{code:`import pygame
import sys
import random
