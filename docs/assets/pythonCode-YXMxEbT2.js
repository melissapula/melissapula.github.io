import{R as f}from"./python-K2aNTn3s.js";import{_ as l,o as n,c as r,a as e,d as p,h as c,r as h,b as O,F as E,e as g,l as L,n as y,t as u,i as v,m as w,p as R}from"./index-Ge-l3G2J.js";const A="/assets/calculator-C-5QCe61.png",S={name:"Calculator",components:{Codemirror:f},data(){return{calculator:null,calculatorOptions:{tabSize:4,mode:"text/x-python",lineNumbers:!0,line:!0,smartIndent:!0,indentUnit:4,indentWithTabs:!0,readOnly:!0,foldGutter:!0}}},methods:{init(){this.calculator=`from tkinter import *
...
if __name__ == "__main__":
    Calculator().mainloop()`}},mounted(){this.init()}},G={class:"container-fluid h-100 mt-0 pt-0"},F={key:0,class:"row pt-4",style:{height:"calc(100vh - var(--site-nav-height, 56px))","background-color":"#f0f2f5"}},I={class:"col-lg-7 col-sm-12"};function b(s,t,d,m,o,a){const i=h("Codemirror");return n(),r("div",G,[o.calculator?(n(),r("div",F,[e("div",I,[p(i,{class:"CodeMirror",style:{width:"100%"},value:o.calculator,options:o.calculatorOptions},null,8,["value","options"])]),t[0]||(t[0]=e("div",{class:"col-lg-5 col-sm-12 pb-4 d-flex flex-column align-items-center",style:{"overflow-y":"auto",height:"calc(100vh - var(--site-nav-height, 56px) - 1.5rem)"}},[e("img",{src:A,class:"img-fluid",alt:"Screenshot of the resulting calculator GUI"}),e("p",{class:"mt-3"},"This code will create a grid for a calculator, as shown here.")],-1))])):c("",!0)])}const W=l(S,[["render",b],["__scopeId","data-v-11e1ae81"]]),N="/assets/macbethMap-DjhSotSc.png",k={name:"macbeth",components:{Codemirror:f},data(){return{macbeth:null,spaces:"    ",tab:"        ",macbethOptions:{tabSize:4,mode:"text/x-python",lineNumbers:!0,line:!0,smartIndent:!0,indentUnit:4,indentWithTabs:!0,readOnly:!0,foldGutter:!0}}},methods:{init(){this.macbeth=`from turtle import Turtle
class playGame():
...
playGame()`}},mounted(){this.init()}},Y={class:"container-fluid h-100 mt-0 pt-0"},_={key:0,class:"row pt-4",style:{height:"calc(100vh - var(--site-nav-height, 56px))","background-color":"#f0f2f5"}},C={class:"col-lg-7 col-sm-12"};function H(s,t,d,m,o,a){const i=h("Codemirror");return n(),r("div",Y,[o.macbeth?(n(),r("div",_,[e("div",C,[p(i,{class:"CodeMirror",style:{width:"100%"},value:o.macbeth,options:o.macbethOptions},null,8,["value","options"])]),t[0]||(t[0]=e("div",{class:"col-lg-5 col-sm-12 pb-4 d-flex flex-column align-items-center",style:{"overflow-y":"auto",height:"calc(100vh - var(--site-nav-height, 56px) - 1.5rem)"}},[e("img",{src:N,class:"img-fluid",alt:"Map of the rooms the player can navigate in the Macbeth adventure game"}),e("p",{class:"mt-3"}," This code is for a game. The goal of the game is to navigate through various rooms, collecting items as you go, and then bringing them all to the last room. Depending on the level of difficulty the user chooses, there is a map that can be drawn as well (as shown). ")],-1))])):c("",!0)])}const x=l(k,[["render",H],["__scopeId","data-v-31f8887b"]]),D={name:"BullsCows",components:{Codemirror:f},data(){return{code:null,codeOptions:{tabSize:4,mode:"text/x-python",lineNumbers:!0,line:!0,smartIndent:!0,indentUnit:4,indentWithTabs:!0,readOnly:!0,foldGutter:!0}}},methods:{init(){this.code=`def main():
    import random
...
if __name__ == "__main__":
    gameOfSticks()`}},mounted(){this.init()}},U={class:"container-fluid h-100 mt-0 pt-0"},$={key:0,class:"row pt-4",style:{height:"calc(100vh - var(--site-nav-height, 56px))","background-color":"#f0f2f5"}},j={class:"col-lg-7 col-sm-12"};function q(s,t,d,m,o,a){const i=h("Codemirror");return n(),r("div",U,[o.code?(n(),r("div",$,[e("div",j,[p(i,{class:"CodeMirror",style:{width:"100%"},value:o.code,options:o.codeOptions},null,8,["value","options"])]),t[0]||(t[0]=e("div",{class:"col-lg-5 col-sm-12 pb-4 d-flex flex-column justify-content-center align-items-center"},[e("p",null,"This code will create a game called Game of Sticks. The game is played as follows:"),e("p",null,"1. The computer asks how many sticks you would like to start with (10-100)."),e("p",null,"2. The two players then take turns reducing the number of sticks (1-3)."),e("p",null,"3. The player who takes the last stick loses.")],-1))])):c("",!0)])}const z=l(V,[["render",q],["__scopeId","data-v-29c9620c"]]),J={name:"Pig",components:{Codemirror:f},data(){return{code:null,codeOptions:{tabSize:4,mode:"text/x-python",lineNumbers:!0,line:!0,smartIndent:!0,indentUnit:4,indentWithTabs:!0,readOnly:!0,foldGutter:!0}}},methods:{init(){this.code=`totalone = 0
totaltwo = 0
while True:
    rollfirst = 0
    while True:
    ...
    if (totaltwo >= 100):
        ...
        break`}},mounted(){this.init()}},Q={class:"container-fluid h-100 mt-0 pt-0"},X={key:0,class:"row pt-4",style:{height:"calc(100vh - var(--site-nav-height, 56px))","background-color":"#f0f2f5"}},ee={class:"col-lg-7 col-sm-12"};function oe(s,t,d,m,o,a){const i=h("Codemirror");return n(),r("div",Q,[o.code?(n(),r("div",X,[e("div",ee,[p(i,{class:"CodeMirror",style:{width:"100%"},value:o.code,options:o.codeOptions},null,8,["value","options"])]),t[0]||(t[0]=O('<div class="col-lg-5 col-sm-12 pb-4 d-flex flex-column justify-content-center align-items-center" data-v-eb8a8f35><p data-v-eb8a8f35>This code will create a game called Game of Pig. The game is played as follows:</p><p data-v-eb8a8f35>Each turn starts with the player making the choice to play or hold.</p><p class="ms-4" data-v-eb8a8f35>If they play the player rolls a single die and looking at the results.</p><p class="ms-4 ps-4" data-v-eb8a8f35>If a 1 was rolled the player scores no points and their turn is over.</p><p class="ms-4 ps-4" data-v-eb8a8f35> If any other number is rolled the player adds the number rolled to the player&#39;s turn total. </p><p class="ms-4" data-v-eb8a8f35> If they hold their turn points are added to their score and it becomes the opponent&#39;s turn. </p></div>',1))])):c("",!0)])}const te=l(J,[["render",oe],["__scopeId","data-v-eb8a8f35"]]),ie="/assets/turtleGraphics-C3QNb8Io.png",ne={name:"Turtle",components:{Codemirror:f},data(){return{code:null,codeOptions:{tabSize:4,mode:"text/x-python",lineNumbers:!0,line:!0,smartIndent:!0,indentUnit:4,indentWithTabs:!0,readOnly:!0,foldGutter:!0}}},methods:{init(){this.code=`from turtle import Turtle
def main():
    t = Turtle()
    t.pensize(2)
    roof(t)
...
if __name__ == "__main__":
    main()`}},mounted(){this.init()}},re={class:"container-fluid h-100 mt-0 pt-0"},se={key:0,class:"row pt-4",style:{height:"calc(100vh - var(--site-nav-height, 56px))","background-color":"#f0f2f5"}},ae={class:"col-lg-7 col-sm-12"};function le(s,t,d,m,o,a){const i=h("Codemirror");return n(),r("div",re,[o.code?(n(),r("div",se,[e("div",ae,[p(i,{class:"CodeMirror",style:{width:"100%"},value:o.code,options:o.codeOptions},null,8,["value","options"])]),t[0]||(t[0]=e("div",{class:"col-lg-5 col-sm-12 pb-4 d-flex flex-column align-items-center",style:{"overflow-y":"auto",height:"calc(100vh - var(--site-nav-height, 56px) - 1.5rem)"}},[e("img",{src:ie,class:"img-fluid",alt:"Generated picture from the Turtle Graphics program"}),e("p",{class:"mt-3"},"This code will create a picture (as shown) using Turtle Graphics.")],-1))])):c("",!0)])}const de=l(ne,[["render",le],["__scopeId","data-v-2df32b54"]]),me="/assets/pygame-C5S-2IfS.png",fe={name:"Pygame",components:{Codemirror:f},data(){return{code:null,codeOptions:{tabSize:4,mode:"text/x-python",lineNumbers:!0,line:!0,smartIndent:!0,indentUnit:4,indentWithTabs:!0,readOnly:!0,foldGutter:!0}}},methods:{init(){this.code=`import pygame
import sys
import random
