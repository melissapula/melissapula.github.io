import{C as f}from"./CodeBlock-CTEFvbfx.js";import{_ as l,o as i,c as s,a as e,d as p,r as c,b as g,F as T,e as E,l as O,n as L,t as h,i as y,m as v,p as w}from"./index-DfqV2WKp.js";const R="/assets/calculator-C-5QCe61.png",A={name:"Calculator",components:{CodeBlock:f},data(){return{calculator:`from tkinter import *
...
if __name__ == "__main__":
    Calculator().mainloop()`}}},S={class:"container-fluid h-100 mt-0 pt-0"},G={class:"row pt-4",style:{height:"calc(100vh - var(--site-nav-height, 56px))","background-color":"#f0f2f5"}},F={class:"col-lg-7 col-sm-12"};function I(r,o,d,m,n,a){const t=c("CodeBlock");return i(),s("div",S,[e("div",G,[e("div",F,[p(t,{code:n.calculator},null,8,["code"])]),o[0]||(o[0]=e("div",{class:"col-lg-5 col-sm-12 pb-4 d-flex flex-column align-items-center",style:{"overflow-y":"auto",height:"calc(100vh - var(--site-nav-height, 56px) - 1.5rem)"}},[e("img",{src:R,class:"img-fluid",alt:"Screenshot of the resulting calculator GUI"}),e("p",{class:"mt-3"},"This code will create a grid for a calculator, as shown here.")],-1))])])}const W=l(A,[["render",I]]),b="/assets/macbethMap-DjhSotSc.png",N={name:"macbeth",components:{CodeBlock:f},data(){return{macbeth:`from turtle import Turtle
class playGame():
...
playGame()`}}},k={class:"container-fluid h-100 mt-0 pt-0"},Y={class:"row pt-4",style:{height:"calc(100vh - var(--site-nav-height, 56px))","background-color":"#f0f2f5"}},_={class:"col-lg-7 col-sm-12"};function C(r,o,d,m,n,a){const t=c("CodeBlock");return i(),s("div",k,[e("div",Y,[e("div",_,[p(t,{code:n.macbeth},null,8,["code"])]),o[0]||(o[0]=e("div",{class:"col-lg-5 col-sm-12 pb-4 d-flex flex-column align-items-center",style:{"overflow-y":"auto",height:"calc(100vh - var(--site-nav-height, 56px) - 1.5rem)"}},[e("img",{src:b,class:"img-fluid",alt:"Map of the rooms the player can navigate in the Macbeth adventure game"}),e("p",{class:"mt-3"}," This code is for a game. The goal of the game is to navigate through various rooms, collecting items as you go, and then bringing them all to the last room. Depending on the level of difficulty the user chooses, there is a map that can be drawn as well (as shown). ")],-1))])])}const H=l(N,[["render",C]]),D={name:"BullsCows",components:{CodeBlock:f},data(){return{code:`def main():
    import random
...
if __name__ == "__main__":
    gameOfSticks()`}}},$={class:"container-fluid h-100 mt-0 pt-0"},V={class:"row pt-4",style:{height:"calc(100vh - var(--site-nav-height, 56px))","background-color":"#f0f2f5"}},U={class:"col-lg-7 col-sm-12"};function j(r,o,d,m,n,a){const t=c("CodeBlock");return i(),s("div",$,[e("div",V,[e("div",U,[p(t,{code:n.code},null,8,["code"])]),o[0]||(o[0]=e("div",{class:"col-lg-5 col-sm-12 pb-4 d-flex flex-column justify-content-center align-items-center"},[e("p",null,"This code will create a game called Game of Sticks. The game is played as follows:"),e("p",null,"1. The computer asks how many sticks you would like to start with (10-100)."),e("p",null,"2. The two players then take turns reducing the number of sticks (1-3)."),e("p",null,"3. The player who takes the last stick loses.")],-1))])])}const q=l(M,[["render",j]]),J={name:"Pig",components:{CodeBlock:f},data(){return{code:`totalone = 0
totaltwo = 0
while True:
    rollfirst = 0
    while True:
    ...
    if (totaltwo >= 100):
        ...
        break`}}},z={class:"container-fluid h-100 mt-0 pt-0"},Q={class:"row pt-4",style:{height:"calc(100vh - var(--site-nav-height, 56px))","background-color":"#f0f2f5"}},X={class:"col-lg-7 col-sm-12"};function ee(r,o,d,m,n,a){const t=c("CodeBlock");return i(),s("div",z,[e("div",Q,[e("div",X,[p(t,{code:n.code},null,8,["code"])]),o[0]||(o[0]=g('<div class="col-lg-5 col-sm-12 pb-4 d-flex flex-column justify-content-center align-items-center"><p>This code will create a game called Game of Pig. The game is played as follows:</p><p>Each turn starts with the player making the choice to play or hold.</p><p class="ms-4">If they play the player rolls a single die and looking at the results.</p><p class="ms-4 ps-4">If a 1 was rolled the player scores no points and their turn is over.</p><p class="ms-4 ps-4"> If any other number is rolled the player adds the number rolled to the player&#39;s turn total. </p><p class="ms-4"> If they hold their turn points are added to their score and it becomes the opponent&#39;s turn. </p></div>',1))])])}const oe=l(J,[["render",ee]]),te="/assets/turtleGraphics-C3QNb8Io.png",ne={name:"Turtle",components:{CodeBlock:f},data(){return{code:`from turtle import Turtle
def main():
    t = Turtle()
    t.pensize(2)
    roof(t)
...
if __name__ == "__main__":
    main()`}}},ie={class:"container-fluid h-100 mt-0 pt-0"},re={class:"row pt-4",style:{height:"calc(100vh - var(--site-nav-height, 56px))","background-color":"#f0f2f5"}},se={class:"col-lg-7 col-sm-12"};function ae(r,o,d,m,n,a){const t=c("CodeBlock");return i(),s("div",ie,[e("div",re,[e("div",se,[p(t,{code:n.code},null,8,["code"])]),o[0]||(o[0]=e("div",{class:"col-lg-5 col-sm-12 pb-4 d-flex flex-column align-items-center",style:{"overflow-y":"auto",height:"calc(100vh - var(--site-nav-height, 56px) - 1.5rem)"}},[e("img",{src:te,class:"img-fluid",alt:"Generated picture from the Turtle Graphics program"}),e("p",{class:"mt-3"},"This code will create a picture (as shown) using Turtle Graphics.")],-1))])])}const le=l(ne,[["render",ae]]),de="/assets/pygame-C5S-2IfS.png",me={name:"Pygame",components:{CodeBlock:f},data(){return{code:`import pygame
import sys
import random
...
while True:
    ...
    clock.tick(60)`}}},fe={class:"container-fluid h-100 mt-0 pt-0"},pe={class:"row pt-4",style:{height:"calc(100vh - var(--site-nav-height, 56px))","background-color":"#f0f2f5"}},ce={class:"col-lg-7 col-sm-12"};function he(r,o,d,m,n,a){const t=c("CodeBlock");return i(),s("div",fe,[e("div",pe,[e("div",ce,[p(t,{code:n.code},null,8,["code"])]),o[0]||(o[0]=e("div",{class:"col-lg-5 col-sm-12 pb-4 d-flex flex-column align-items-center",style:{"overflow-y":"auto",height:"calc(100vh - var(--site-nav-height, 56px) - 1.5rem)"}},[e("img",{src:de,class:"img-fluid",style:{"max-width":"60%"},alt:"Screenshot of the Pygame movie-picker window"}),e("p",{class:"mt-3"},"This code will create a pygame program as shown."),e("p",null," You import a list of movies to choose from, then you enter a number in the input box and the program will randomly choose a movie for you. ")],-1))])])}const ue=l(me,[["render",he]]),Te={name:"PythonCode",components:{Calculator:W,Macbeth:H,BullsCows:K,Sticks:q,Pig:oe,Turtle:le,Pygame:ue},computed:{selectedProject:{get(){const r=this.$route.query.project;return r&&this.projectComponents[r]?r:null},set(r){r?this.$router.push({query:{project:r}}):this.$router.push({query:{}})}}},data(){return{projectComponents:{calculator:"Calculator",macbeth:"Macbeth",bullsCows:"BullsCows",sticks:"Sticks",pig:"Pig",turtle:"Turtle",pygame:"Pygame"},projects:[{key:"calculator",title:"Calculator",subtitle:"Tkinter grid layout",description:"A four-function calculator built with Python and Tkinter, demonstrating grid-based widget layout and event handling.",tags:["Python","Tkinter","GUI"],previewClass:"preview-blue"},{key:"macbeth",title:"Macbeth Game",subtitle:"Text-based adventure",description:"A text-based adventure game set in the world of Shakespeare's Macbeth, with map navigation between locations.",tags:["Python","Game","CLI"],previewClass:"preview-burgundy"},{key:"bullsCows",title:"Bulls and Cows",subtitle:"Number-guessing game",description:"A classic deduction game — guess the computer's four-digit secret number using feedback on how many digits are correct and in the right position.",tags:["Python","Game","Logic"],previewClass:"preview-amber"},{key:"sticks",title:"Game of Sticks",subtitle:"Two-player strategy",description:"A two-player turn-based game starting with 10–100 sticks. Each player removes 1–3 per turn; whoever takes the last stick loses.",tags:["Python","Game","Strategy"],previewClass:"preview-green"},{key:"pig",title:"Game of Pig",subtitle:"Push-your-luck dice",description:"A push-your-luck dice game. Roll to rack up points, but rolling a 1 wipes the turn's score. First to the target total wins.",tags:["Python","Game","Dice"],previewClass:"preview-purple"},{key:"turtle",title:"Turtle Graphics",subtitle:"Generative drawing",description:"A generative graphics program built on Python's Turtle library, producing a layered geometric drawing from primitive turtle commands.",tags:["Python","Turtle","Graphics"],previewClass:"preview-teal"},{key:"pygame",title:"Pygame",subtitle:"Interactive game loop",description:"An interactive Pygame demo showing sprite rendering, the event loop, and frame-based animation patterns.",tags:["Python","Pygame","Game"],previewClass:"preview-orange"}]}}},Ee={key:0,class:"container-fluid mt-0 pt-0"},ge={class:"row justify-content-center pt-5",style:{"background-color":"#f0f2f5","min-height":"calc(100vh - var(--site-nav-height, 56px))"}},Oe={class:"col-lg-10 col-md-11"},Le={class:"row justify-content-center"},ye=["onClick","onKeyup"],ve={class:"preview-content"},we={class:"preview-title"},Re={class:"preview-subtitle"},Ae={class:"project-info"},Se={style:{color:"#1a2744"}},Ge={class:"tech-tags mb-3"},Fe={key:1,class:"project-view"};function Ie(r,o,d,m,n,a){return i(),s("div",null,[a.selectedProject?(i(),s("div",Fe,[e("mfp-button",{class:"back-button",variant:"secondary",onClick:o[0]||(o[0]=t=>a.selectedProject=null)},[...o[3]||(o[3]=[e("i",{class:"fas fa-arrow-left me-2","aria-hidden":"true"},null,-1),y("Back to Python Project ",-1)])]),(i(),v(w(n.projectComponents[a.selectedProject])))])):(i(),s("div",Ee,[e("div",ge,[e("div",Oe,[o[2]||(o[2]=e("h2",{class:"text-center mb-4",style:{color:"#1a2744","font-weight":"bold"}},"Python Project",-1)),e("div",Le,[(i(!0),s(T,null,E(n.projects,t=>(i(),s("div",{class:"col-lg-4 col-md-6 mb-4",key:t.key},[e("div",{class:"project-card",onClick:u=>a.selectedProject=t.key,tabindex:"0",role:"button",onKeyup:O(u=>a.selectedProject=t.key,["enter"])},[e("div",{class:L(["project-preview",t.previewClass])},[e("div",ve,[e("span",we,h(t.title),1),e("span",Re,h(t.subtitle),1)])],2),e("div",Ae,[e("h4",Se,h(t.title),1),e("p",null,h(t.description),1),e("div",Ge,[(i(!0),s(T,null,E(t.tags,u=>(i(),s("mfp-badge",{key:u},h(u),1))),128))]),o[1]||(o[1]=e("mfp-button",{class:"card-cta",variant:"primary"},"View Project",-1))])],40,ye)]))),128))])])])]))])}const Ne=l(Te,[["render",Ie],["__scopeId","data-v-a1a49d98"]]);export{Ne as default};
