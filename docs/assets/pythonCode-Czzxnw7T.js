import{R as f}from"./python-CQ027T7k.js";import{_ as l,o as n,c as r,a as e,d as p,h as c,r as h,b as O,F as E,e as g,l as L,n as y,t as u,i as v,m as w,p as R}from"./index-CNNfhZuO.js";const A="/assets/calculator-C-5QCe61.png",S={name:"Calculator",components:{Codemirror:f},data(){return{calculator:null,calculatorOptions:{tabSize:4,mode:"text/x-python",lineNumbers:!0,line:!0,smartIndent:!0,indentUnit:4,indentWithTabs:!0,readOnly:!0,foldGutter:!0}}},methods:{init(){this.calculator=`from tkinter import *
...
while True:
    ...
    if (totaltwo >= 100):
        ...
        break`}},mounted(){this.init()}},Q={class:"container-fluid h-100 mt-0 pt-0"},X={key:0,class:"row pt-4",style:{height:"calc(100vh - var(--site-nav-height, 56px))","background-color":"#f0f2f5"}},ee={class:"col-lg-7 col-sm-12"};function oe(s,t,d,m,o,a){const i=h("Codemirror");return n(),r("div",Q,[o.code?(n(),r("div",X,[e("div",ee,[p(i,{class:"CodeMirror",style:{width:"100%"},value:o.code,options:o.codeOptions},null,8,["value","options"])]),t[0]||(t[0]=O('<div class="col-lg-5 col-sm-12 pb-4 d-flex flex-column justify-content-center align-items-center" data-v-e8ddb44c><p data-v-e8ddb44c>This code will create a game called Game of Pig. The game is played as follows:</p><p data-v-e8ddb44c>Each turn starts with the player making the choice to play or hold.</p><p class="ms-4" data-v-e8ddb44c>If they play the player rolls a single die and looking at the results.</p><p class="ms-4 ps-4" data-v-e8ddb44c>If a 1 was rolled the player scores no points and their turn is over.</p><p class="ms-4 ps-4" data-v-e8ddb44c> If any other number is rolled the player adds the number rolled to the player&#39;s turn total. </p><p class="ms-4" data-v-e8ddb44c> If they hold their turn points are added to their score and it becomes the opponent&#39;s turn. </p></div>',1))])):c("",!0)])}const te=l(J,[["render",oe],["__scopeId","data-v-e8ddb44c"]]),ie="/assets/turtleGraphics-C3QNb8Io.png",ne={name:"Turtle",components:{Codemirror:f},data(){return{code:null,codeOptions:{tabSize:4,mode:"text/x-python",lineNumbers:!0,line:!0,smartIndent:!0,indentUnit:4,indentWithTabs:!0,readOnly:!0,foldGutter:!0}}},methods:{init(){this.code=`from turtle import Turtle
def main():
    t = Turtle()
    t.pensize(2)
    roof(t)
...
if __name__ == "__main__":
    main()`}},mounted(){this.init()}},re={class:"container-fluid h-100 mt-0 pt-0"},se={key:0,class:"row pt-4",style:{height:"calc(100vh - var(--site-nav-height, 56px))","background-color":"#f0f2f5"}},ae={class:"col-lg-7 col-sm-12"};function le(s,t,d,m,o,a){const i=h("Codemirror");return n(),r("div",re,[o.code?(n(),r("div",se,[e("div",ae,[p(i,{class:"CodeMirror",style:{width:"100%"},value:o.code,options:o.codeOptions},null,8,["value","options"])]),t[0]||(t[0]=e("div",{class:"col-lg-5 col-sm-12 pb-4 d-flex flex-column align-items-center",style:{"overflow-y":"auto",height:"calc(100vh - 90px)"}},[e("img",{src:ie,class:"img-fluid",alt:"Generated picture from the Turtle Graphics program"}),e("p",{class:"mt-3"},"This code will create a picture (as shown) using Turtle Graphics.")],-1))])):c("",!0)])}const de=l(ne,[["render",le],["__scopeId","data-v-6f0ea19a"]]),me="/assets/pygame-C5S-2IfS.png",fe={name:"Pygame",components:{Codemirror:f},data(){return{code:null,codeOptions:{tabSize:4,mode:"text/x-python",lineNumbers:!0,line:!0,smartIndent:!0,indentUnit:4,indentWithTabs:!0,readOnly:!0,foldGutter:!0}}},methods:{init(){this.code=`import pygame
import sys
import random
