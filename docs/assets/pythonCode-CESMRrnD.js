...
if __name__ == "__main__":
    Calculator().mainloop()`}}};function G(a,o,p,c,n,d){const i=s("CodeBlock"),t=s("ProjectShell");return l(),m(t,null,{code:r(()=>[u(i,{code:n.calculator},null,8,["code"])]),summary:r(()=>[...o[0]||(o[0]=[e("img",{src:A,class:"img-fluid",alt:"Screenshot of the resulting calculator GUI"},null,-1),e("p",{class:"mt-md"},"This code will create a grid for a calculator, as shown here.",-1)])]),_:1})}const F=f(S,[["render",G]]),I="/assets/macbethMap-DjhSotSc.png",W={name:"macbeth",components:{CodeBlock:h,ProjectShell:T},data(){return{macbeth:`from turtle import Turtle
class playGame():
...
playGame()`}}};function b(a,o,p,c,n,d){const i=s("CodeBlock"),t=s("ProjectShell");return l(),m(t,null,{code:r(()=>[u(i,{code:n.macbeth},null,8,["code"])]),summary:r(()=>[...o[0]||(o[0]=[e("img",{src:I,class:"img-fluid",alt:"Map of the rooms the player can navigate in the Macbeth adventure game"},null,-1),e("p",{class:"mt-md"}," This code is for a game. The goal of the game is to navigate through various rooms, collecting items as you go, and then bringing them all to the last room. Depending on the level of difficulty the user chooses, there is a map that can be drawn as well (as shown). ",-1)])]),_:1})}const N=f(W,[["render",b]]),k={name:"BullsCows",components:{CodeBlock:h,ProjectShell:T},data(){return{code:`def main():
    import random
...
main()  `}}};function Y(a,o,p,c,n,d){const i=s("CodeBlock"),t=s("ProjectShell");return l(),m(t,{"center-summary":""},{code:r(()=>[u(i,{code:n.code},null,8,["code"])]),summary:r(()=>[...o[0]||(o[0]=[e("p",null,"This code will create a game called Bulls and Cows. The game is played as follows:",-1),e("p",null,"1. The computer picks a four-digit number with no repeating digits. This is the secret number.",-1),e("p",null,"2. The user makes a guess.",-1),e("p",null,"3. The computer determines the number of bulls and the number of cows.",-1),e("p",{class:"ml-lg"},"a. Bulls are digits which are in the correct position.",-1),e("p",{class:"ml-lg"},"b. Cows are digits that are in the secret number but are in the wrong position.",-1),e("p",null," 4. The computer then prints out all the guesses and their bull and cow counts. NOTE: These numbers added together should never be more than four. ",-1),e("p",null,"5. If all the digits are bulls, the game is over, otherwise go to step 2.",-1),e("p",null,"6. When the game is over the computer will ask you if you want to play again.",-1)])]),_:1})}const C=f(k,[["render",Y]]),_={name:"Sticks",components:{CodeBlock:h,ProjectShell:T},data(){return{code:`class gameOfSticks():
    def __init__(self):
...
if __name__ == "__main__":
    gameOfSticks()`}}};function H(a,o,p,c,n,d){const i=s("CodeBlock"),t=s("ProjectShell");return l(),m(t,{"center-summary":""},{code:r(()=>[u(i,{code:n.code},null,8,["code"])]),summary:r(()=>[...o[0]||(o[0]=[e("p",null,"This code will create a game called Game of Sticks. The game is played as follows:",-1),e("p",null,"1. The computer asks how many sticks you would like to start with (10-100).",-1),e("p",null,"2. The two players then take turns reducing the number of sticks (1-3).",-1),e("p",null,"3. The player who takes the last stick loses.",-1)])]),_:1})}const P=f(_,[["render",H]]),D={name:"Pig",components:{CodeBlock:h,ProjectShell:T},data(){return{code:`totalone = 0
totaltwo = 0
while True:
    rollfirst = 0
    while True:
    ...
    if (totaltwo >= 100):
        ...
        break`}}};function x(a,o,p,c,n,d){const i=s("CodeBlock"),t=s("ProjectShell");return l(),m(t,{"center-summary":""},{code:r(()=>[u(i,{code:n.code},null,8,["code"])]),summary:r(()=>[...o[0]||(o[0]=[e("p",null,"This code will create a game called Game of Pig. The game is played as follows:",-1),e("p",null,"Each turn starts with the player making the choice to play or hold.",-1),e("p",{class:"ml-lg"},"If they play the player rolls a single die and looking at the results.",-1),e("p",{class:"ml-lg pl-lg"},"If a 1 was rolled the player scores no points and their turn is over.",-1),e("p",{class:"ml-lg pl-lg"}," If any other number is rolled the player adds the number rolled to the player's turn total. ",-1),e("p",{class:"ml-lg"}," If they hold their turn points are added to their score and it becomes the opponent's turn. ",-1)])]),_:1})}const Z=f(D,[["render",x]]),B="/assets/turtleGraphics-C3QNb8Io.png",M={name:"Turtle",components:{CodeBlock:h,ProjectShell:T},data(){return{code:`from turtle import Turtle
def main():
    t = Turtle()
    t.pensize(2)
    roof(t)
...
if __name__ == "__main__":
    main()`}}};function K(a,o,p,c,n,d){const i=s("CodeBlock"),t=s("ProjectShell");return l(),m(t,null,{code:r(()=>[u(i,{code:n.code},null,8,["code"])]),summary:r(()=>[...o[0]||(o[0]=[e("img",{src:B,class:"img-fluid",alt:"Generated picture from the Turtle Graphics program"},null,-1),e("p",{class:"mt-md"},"This code will create a picture (as shown) using Turtle Graphics.",-1)])]),_:1})}const V=f(M,[["render",K]]),U="/assets/pygame-C5S-2IfS.png",j={name:"Pygame",components:{CodeBlock:h},data(){return{code:`import pygame
import sys
import random
...
while True:
    ...
    clock.tick(60)`}}};function $(a,o,p,c,n,d){const i=s("CodeBlock"),t=s("ProjectShell");return l(),m(t,null,{code:r(()=>[u(i,{code:n.code},null,8,["code"])]),summary:r(()=>[...o[0]||(o[0]=[e("img",{src:U,class:"img-fluid",style:{"max-width":"60%"},alt:"Screenshot of the Pygame movie-picker window"},null,-1),e("p",{class:"mt-md"},"This code will create a pygame program as shown.",-1),e("p",null," You import a list of movies to choose from, then you enter a number in the input box and the program will randomly choose a movie for you. ",-1)])]),_:1})}const q=f(j,[["render",$]]),J={name:"PythonCode",components:{Calculator:F,Macbeth:N,BullsCows:C,Sticks:P,Pig:Z,Turtle:V,Pygame:q,ProjectCard:R},computed:{selectedProject:{get(){const a=this.$route.query.project;return a&&this.projectComponents[a]?a:null},set(a){a?this.$router.push({query:{project:a}}):this.$router.push({query:{}})}}},data(){return{projectComponents:{calculator:"Calculator",macbeth:"Macbeth",bullsCows:"BullsCows",sticks:"Sticks",pig:"Pig",turtle:"Turtle",pygame:"Pygame"},projects:[{key:"calculator",title:"Calculator",subtitle:"Tkinter grid layout",description:"A four-function calculator built with Python and Tkinter, demonstrating grid-based widget layout and event handling.",tags:["Python","Tkinter","GUI"],previewClass:"preview-blue"},{key:"macbeth",title:"Macbeth Game",subtitle:"Text-based adventure",description:"A text-based adventure game set in the world of Shakespeare's Macbeth, with map navigation between locations.",tags:["Python","Game","CLI"],previewClass:"preview-burgundy"},{key:"bullsCows",title:"Bulls and Cows",subtitle:"Number-guessing game",description:"A classic deduction game — guess the computer's four-digit secret number using feedback on how many digits are correct and in the right position.",tags:["Python","Game","Logic"],previewClass:"preview-amber"},{key:"sticks",title:"Game of Sticks",subtitle:"Two-player strategy",description:"A two-player turn-based game starting with 10–100 sticks. Each player removes 1–3 per turn; whoever takes the last stick loses.",tags:["Python","Game","Strategy"],previewClass:"preview-green"},{key:"pig",title:"Game of Pig",subtitle:"Push-your-luck dice",description:"A push-your-luck dice game. Roll to rack up points, but rolling a 1 wipes the turn's score. First to the target total wins.",tags:["Python","Game","Dice"],previewClass:"preview-purple"},{key:"turtle",title:"Turtle Graphics",subtitle:"Generative drawing",description:"A generative graphics program built on Python's Turtle library, producing a layered geometric drawing from primitive turtle commands.",tags:["Python","Turtle","Graphics"],previewClass:"preview-teal"},{key:"pygame",title:"Pygame",subtitle:"Interactive game loop",description:"An interactive Pygame demo showing sprite rendering, the event loop, and frame-based animation patterns.",tags:["Python","Pygame","Game"],previewClass:"preview-orange"}]}}},z={key:0,size:"2xl",class:"swap-page"},Q={class:"cards-grid"},X={class:"preview-content"},ee={class:"preview-title"},oe={class:"preview-subtitle"},te={key:1,class:"project-view"};function ne(a,o,p,c,n,d){const i=s("ProjectCard");return l(),E("div",null,[d.selectedProject?(l(),E("div",te,[e("mfp-button",{class:"back-button",variant:"secondary",onClick:o[0]||(o[0]=t=>d.selectedProject=null)},[...o[2]||(o[2]=[e("i",{class:"fas fa-arrow-left mr-sm","aria-hidden":"true"},null,-1),w("Back to Python Project ",-1)])]),(l(),m(v(n.projectComponents[d.selectedProject])))])):(l(),E("mfp-container",z,[o[1]||(o[1]=e("h2",{class:"page-heading text-center mb-lg"},"Python Project",-1)),e("div",Q,[(l(!0),E(g,null,L(n.projects,t=>(l(),m(i,{key:t.key,title:t.title,description:t.description,tags:t.tags,"cta-text":"View Project",onSelect:ie=>d.selectedProject=t.key},{preview:r(()=>[e("div",{class:y(["project-preview",t.previewClass])},[e("div",X,[e("span",ee,O(t.title),1),e("span",oe,O(t.subtitle),1)])],2)]),_:2},1032,["title","description","tags","onSelect"]))),128))])]))])}const le=f(J,[["render",ne],["__scopeId","data-v-60ca083a"]]);export{le as default};
