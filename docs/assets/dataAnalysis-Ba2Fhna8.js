import{C as f}from"./CodeBlock-CTEFvbfx.js";import{_ as m,o as a,c as r,a as e,d as u,b as g,r as h,F as v,e as A,l as w,n as b,t as l,i as y,m as C,p as x}from"./index-DfqV2WKp.js";const k="/assets/wordCount1-DJa4bk2R.png",R="/assets/wordCount2-HZggeBLV.png",I="/assets/wordCount3-I1HBpdBM.png",F={name:"WordCount",components:{CodeBlock:f},data(){return{wordCount:`from pyspark.sql import SparkSession
...
#see image(3) for resulting word count and time it took to achieve`}}},z={class:"container-fluid h-100 mt-0 pt-0"},P={class:"row pt-4",style:{height:"calc(100vh - var(--site-nav-height, 56px))","background-color":"#f0f2f5"}},M={class:"col-lg-7 col-sm-12"};function j(i,t,p,d,o,n){const s=h("CodeBlock");return a(),r("div",z,[e("div",P,[e("div",M,[u(s,{code:o.wordCount},null,8,["code"])]),t[0]||(t[0]=g('<div class="col-lg-5 col-sm-12 pb-4 d-flex flex-column align-items-center" style="overflow-y:auto;height:calc(100vh - var(--site-nav-height, 56px) - 1.5rem);"><img src="'+k+'" class="img-fluid" alt="First five rows of the imported CSV file"><p class="mt-2">Image(1): The first five rows of the imported csv file.</p><img src="'+R+'" class="img-fluid mt-3" alt="Top 20 most frequent words ranked in descending order"><p class="mt-2"> Image(2): The word count of each word in the file, listed by number of appearance in descending order and limited to the top 20. </p><img src="'+I+'" class="img-fluid mt-3" alt="Top three words with counts and the elapsed processing time"><p class="mt-2"> Image(3): The word count of the top three words as well as the time it took to find these counts. </p></div>',1))])])}const K=m(F,[["render",j]]),S="/assets/imageClusteringPCA-CNg8A0FE.jpg",H="/assets/imageClusteringPCA3D-Dy2-S3h6.png",T="/assets/imageClusteringElbow-DS68TNNt.png",D="/assets/imageClusteringYellowbrick-mczD8DHr.png",W="/assets/imageClusteringKmeans-BoOW1Xls.png",E="/assets/imageClusteringSilhouette-CirTGNPZ.png",V="/assets/imageClusteringViewCluster-NOW9MuWP.jpg",X={name:"ImageClustering",components:{CodeBlock:f},data(){return{imageClustering:`# for loading/processing the images
...
fig = px.imshow(metrics.confusionMatrix().toArray(),
                ...
                y=['False', 'True'])
fig.show()
            `}}},ie={class:"container-fluid h-100 mt-0 pt-0"},re={class:"row pt-4",style:{height:"calc(100vh - var(--site-nav-height, 56px))","background-color":"#f0f2f5"}},oe={class:"col-lg-7 col-sm-12"};function ne(i,t,p,d,o,n){const s=h("CodeBlock");return a(),r("div",ie,[e("div",re,[e("div",oe,[u(s,{code:o.rfc},null,8,["code"])]),t[0]||(t[0]=g('<div class="col-lg-5 col-sm-12 pb-4 d-flex flex-column align-items-center" style="overflow-y:auto;height:calc(100vh - var(--site-nav-height, 56px) - 1.5rem);"><p>This code imports a 1TB dataset and then performs predictive analysis on it.</p><img src="'+Q+'" class="img-fluid mt-3" alt="Initial table from imported dataset"><p class="mt-2">Image(1): Initial table.</p><img src="'+G+'" class="img-fluid mt-3" alt="Table after null values dropped"><p class="mt-2">Image(2): Table after null values have been dropped.</p><img src="'+Z+'" class="img-fluid mt-3" alt="Boolean target counts grouped"><p class="mt-2">Image(3): Boolean counts.</p><img src="'+O+'" class="img-fluid mt-3" alt="Table after running through preprocessing pipeline"><p class="mt-2">Image(4): Table after running through pipeline.</p><img src="'+N+'" class="img-fluid mt-3" alt="Sample rows from the training dataset"><p class="mt-2">Image(5): Table showing some of the values in the train dataset.</p><img src="'+U+'" class="img-fluid mt-3" alt="Boolean target counts in the training dataset"><p class="mt-2">Image(6): Boolean count for train dataset.</p><img src="'+q+'" class="img-fluid mt-3" alt="Sample rows from the test dataset"><p class="mt-2">Image(7): Table showing some of the values in the test dataset.</p><img src="'+$+'" class="img-fluid mt-3" alt="Boolean target counts in the test dataset"><p class="mt-2">Image(8): Boolean count for test dataset.</p><img src="'+ee+'" class="img-fluid mt-3" alt="Random Forest prediction model output"><p class="mt-2">Image(9): Prediction model.</p><img src="'+te+'" class="img-fluid mt-3" alt="Table comparing predicted values against actual values"><p class="mt-2">Image(10): Predictions vs actual.</p><img src="'+se+'" class="img-fluid mt-3" alt="Final accuracy score of the trained model"><p class="mt-2">Image(11): Accuracy of predictions.</p></div>',1))])])}const le=m(ae,[["render",ne]]),ce={name:"DataAnalysis",components:{WordCount:K,ImageClustering:J,RandomForestClassifier:le},computed:{selectedProject:{get(){const i=this.$route.query.project;return i&&this.projectComponents[i]?i:null},set(i){i?this.$router.push({query:{project:i}}):this.$router.push({query:{}})}}},data(){return{projectComponents:{wordcount:"WordCount",imageclustering:"ImageClustering",randomforestclassifier:"RandomForestClassifier"},projects:[{key:"wordcount",title:"Word Count",subtitle:"CSV text frequency analysis",description:"Loads a CSV corpus with pandas, tokenizes the text, and ranks words by frequency. Surfaces the top 20 results along with timing on the most common terms.",tags:["Python","Pandas","Text Analysis"],previewClass:"preview-indigo"},{key:"imageclustering",title:"Image Clustering",subtitle:"Unsupervised feature grouping",description:"Takes an unlabeled dataset of drone images and groups them into clusters based on extracted features. Uses PCA for dimensionality reduction with 2D and 3D scatterplots, then K-means tuned with elbow and silhouette plots.",tags:["Python","scikit-learn","PCA","K-means"],previewClass:"preview-cyan"},{key:"randomforestclassifier",title:"Random Forest Classifier",subtitle:"Predictive analysis at scale",description:"Ingests a 1TB dataset, cleans null values, groups and transforms features, then trains a Random Forest model and evaluates accuracy on a held-out test set.",tags:["Python","scikit-learn","Random Forest","Pandas"],previewClass:"preview-rose"}]}}},me={key:0,class:"container-fluid mt-0 pt-0"},pe={class:"row justify-content-center pt-5",style:{"background-color":"#f0f2f5","min-height":"calc(100vh - var(--site-nav-height, 56px))"}},de={class:"col-lg-10 col-md-11"},fe={class:"row justify-content-center"},ue=["onClick","onKeyup"],ge={class:"preview-content"},he={class:"preview-title"},ve={class:"preview-subtitle"},Ae={class:"project-info"},we={style:{color:"#1a2744"}},be={class:"tech-tags mb-3"},ye={key:1,class:"project-view"};function Ce(i,t,p,d,o,n){return a(),r("div",null,[n.selectedProject?(a(),r("div",ye,[e("mfp-button",{class:"back-button",variant:"secondary",onClick:t[0]||(t[0]=s=>n.selectedProject=null)},[...t[3]||(t[3]=[e("i",{class:"fas fa-arrow-left me-2","aria-hidden":"true"},null,-1),y("Back to Data Analysis ",-1)])]),(a(),C(x(o.projectComponents[n.selectedProject])))])):(a(),r("div",me,[e("div",pe,[e("div",de,[t[2]||(t[2]=e("h2",{class:"text-center mb-4",style:{color:"#1a2744","font-weight":"bold"}},"Data Analysis",-1)),e("div",fe,[(a(!0),r(v,null,A(o.projects,s=>(a(),r("div",{class:"col-lg-4 col-md-6 mb-4",key:s.key},[e("div",{class:"project-card",onClick:c=>n.selectedProject=s.key,tabindex:"0",role:"button",onKeyup:w(c=>n.selectedProject=s.key,["enter"])},[e("div",{class:b(["project-preview",s.previewClass])},[e("div",ge,[e("span",he,l(s.title),1),e("span",ve,l(s.subtitle),1)])],2),e("div",Ae,[e("h4",we,l(s.title),1),e("p",null,l(s.description),1),e("div",be,[(a(!0),r(v,null,A(s.tags,c=>(a(),r("mfp-badge",{key:c},l(c),1))),128))]),t[1]||(t[1]=e("mfp-button",{class:"card-cta",variant:"primary"},"View Project",-1))])],40,ue)]))),128))])])])]))])}const Re=m(ce,[["render",Ce],["__scopeId","data-v-82c3c162"]]);export{Re as default};
