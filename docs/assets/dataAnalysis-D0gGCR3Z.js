import{R as f}from"./python-D_L-Luvz.js";import{_ as m,o as r,c as i,a as e,d as u,b as g,i as h,r as v,F as A,e as b,l as w,n as y,t as l,j as C,m as x,p as k}from"./index-BznSsxV3.js";const I="/assets/wordCount1-DJa4bk2R.png",R="/assets/wordCount2-HZggeBLV.png",F="/assets/wordCount3-I1HBpdBM.png",z={name:"WordCount",components:{Codemirror:f},data(){return{wordCount:null,spaces:"    ",tab:"        ",wordCountOptions:{tabSize:4,mode:"text/x-python",lineNumbers:!0,line:!0,smartIndent:!0,indentUnit:4,indentWithTabs:!0,readOnly:!0,foldGutter:!0}}},methods:{init(){this.wordCount=`from pyspark.sql import SparkSession
...
#see image(3) for resulting word count and time it took to achieve`}},mounted(){this.init()}},P={class:"container-fluid h-100 mt-0 pt-0"},M={key:0,class:"row pt-4",style:{height:"calc(100vh - 56px)","background-color":"#f0f2f5"}},j={class:"col-lg-7 col-sm-12"};function S(o,t,d,p,a,n){const s=v("Codemirror");return r(),i("div",P,[a.wordCount?(r(),i("div",M,[e("div",j,[u(s,{class:"CodeMirror",style:{width:"100%"},value:a.wordCount,options:a.wordCountOptions},null,8,["value","options"])]),t[0]||(t[0]=g('<div class="col-lg-5 col-sm-12 pb-4 d-flex flex-column align-items-center" style="overflow-y:auto;height:calc(100vh - 90px);" data-v-6a0f7155><img src="'+I+'" class="img-fluid" alt="First five rows of the imported CSV file" data-v-6a0f7155><p class="mt-2" data-v-6a0f7155>Image(1): The first five rows of the imported csv file.</p><img src="'+R+'" class="img-fluid mt-3" alt="Top 20 most frequent words ranked in descending order" data-v-6a0f7155><p class="mt-2" data-v-6a0f7155> Image(2): The word count of each word in the file, listed by number of appearance in descending order and limited to the top 20. </p><img src="'+F+'" class="img-fluid mt-3" alt="Top three words with counts and the elapsed processing time" data-v-6a0f7155><p class="mt-2" data-v-6a0f7155> Image(3): The word count of the top three words as well as the time it took to find these counts. </p></div>',1))])):h("",!0)])}const T=m(z,[["render",S],["__scopeId","data-v-6a0f7155"]]),K="/assets/imageClusteringPCA-CNg8A0FE.jpg",W="/assets/imageClusteringPCA3D-Dy2-S3h6.png",H="/assets/imageClusteringElbow-DS68TNNt.png",D="/assets/imageClusteringYellowbrick-mczD8DHr.png",E="/assets/imageClusteringKmeans-BoOW1Xls.png",V="/assets/imageClusteringSilhouette-CirTGNPZ.png",_="/assets/imageClusteringViewCluster-NOW9MuWP.jpg",X={name:"ImageClustering",components:{Codemirror:f},data(){return{imageClustering:null,spaces:"    ",tab:"        ",imageClusteringOptions:{tabSize:4,mode:"text/x-python",lineNumbers:!0,line:!0,smartIndent:!0,indentUnit:4,indentWithTabs:!0,readOnly:!0,foldGutter:!0}}},methods:{init(){this.imageClustering=`# for loading/processing the images
...
fig = px.imshow(metrics.confusionMatrix().toArray(),
                ...
                y=['False', 'True'])
fig.show()
            `}},mounted(){this.init()}},ie={class:"container-fluid h-100 mt-0 pt-0"},oe={key:0,class:"row pt-4",style:{height:"calc(100vh - 56px)","background-color":"#f0f2f5"}},ne={class:"col-lg-7 col-sm-12"};function le(o,t,d,p,a,n){const s=v("Codemirror");return r(),i("div",ie,[a.rfc?(r(),i("div",oe,[e("div",ne,[u(s,{class:"CodeMirror",style:{width:"100%"},value:a.rfc,options:a.rfcOptions},null,8,["value","options"])]),t[0]||(t[0]=g('<div class="col-lg-5 col-sm-12 pb-4 d-flex flex-column align-items-center" style="overflow-y:auto;height:calc(100vh - 90px);" data-v-37393686><p data-v-37393686>This code imports a 1TB dataset and then performs predictive analysis on it.</p><img src="'+Q+'" class="img-fluid mt-3" alt="Initial table from imported dataset" data-v-37393686><p class="mt-2" data-v-37393686>Image(1): Initial table.</p><img src="'+O+'" class="img-fluid mt-3" alt="Table after null values dropped" data-v-37393686><p class="mt-2" data-v-37393686>Image(2): Table after null values have been dropped.</p><img src="'+Z+'" class="img-fluid mt-3" alt="Boolean target counts grouped" data-v-37393686><p class="mt-2" data-v-37393686>Image(3): Boolean counts.</p><img src="'+N+'" class="img-fluid mt-3" alt="Table after running through preprocessing pipeline" data-v-37393686><p class="mt-2" data-v-37393686>Image(4): Table after running through pipeline.</p><img src="'+U+'" class="img-fluid mt-3" alt="Sample rows from the training dataset" data-v-37393686><p class="mt-2" data-v-37393686>Image(5): Table showing some of the values in the train dataset.</p><img src="'+q+'" class="img-fluid mt-3" alt="Boolean target counts in the training dataset" data-v-37393686><p class="mt-2" data-v-37393686>Image(6): Boolean count for train dataset.</p><img src="'+$+'" class="img-fluid mt-3" alt="Sample rows from the test dataset" data-v-37393686><p class="mt-2" data-v-37393686>Image(7): Table showing some of the values in the test dataset.</p><img src="'+ee+'" class="img-fluid mt-3" alt="Boolean target counts in the test dataset" data-v-37393686><p class="mt-2" data-v-37393686>Image(8): Boolean count for test dataset.</p><img src="'+te+'" class="img-fluid mt-3" alt="Random Forest prediction model output" data-v-37393686><p class="mt-2" data-v-37393686>Image(9): Prediction model.</p><img src="'+se+'" class="img-fluid mt-3" alt="Table comparing predicted values against actual values" data-v-37393686><p class="mt-2" data-v-37393686>Image(10): Predictions vs actual.</p><img src="'+ae+'" class="img-fluid mt-3" alt="Final accuracy score of the trained model" data-v-37393686><p class="mt-2" data-v-37393686>Image(11): Accuracy of predictions.</p></div>',1))])):h("",!0)])}const ce=m(re,[["render",le],["__scopeId","data-v-37393686"]]),me={name:"DataAnalysis",components:{WordCount:T,ImageClustering:G,RandomForestClassifier:ce},computed:{selectedProject:{get(){const o=this.$route.query.project;return o&&this.projectComponents[o]?o:null},set(o){o?this.$router.push({query:{project:o}}):this.$router.push({query:{}})}}},data(){return{projectComponents:{wordcount:"WordCount",imageclustering:"ImageClustering",randomforestclassifier:"RandomForestClassifier"},projects:[{key:"wordcount",title:"Word Count",subtitle:"CSV text frequency analysis",description:"Loads a CSV corpus with pandas, tokenizes the text, and ranks words by frequency. Surfaces the top 20 results along with timing on the most common terms.",tags:["Python","Pandas","Text Analysis"],previewClass:"preview-indigo"},{key:"imageclustering",title:"Image Clustering",subtitle:"Unsupervised feature grouping",description:"Takes an unlabeled dataset of drone images and groups them into clusters based on extracted features. Uses PCA for dimensionality reduction with 2D and 3D scatterplots, then K-means tuned with elbow and silhouette plots.",tags:["Python","scikit-learn","PCA","K-means"],previewClass:"preview-cyan"},{key:"randomforestclassifier",title:"Random Forest Classifier",subtitle:"Predictive analysis at scale",description:"Ingests a 1TB dataset, cleans null values, groups and transforms features, then trains a Random Forest model and evaluates accuracy on a held-out test set.",tags:["Python","scikit-learn","Random Forest","Pandas"],previewClass:"preview-rose"}]}}},de={key:0,class:"container-fluid mt-0 pt-0"},pe={class:"row justify-content-center pt-5",style:{"background-color":"#f0f2f5","min-height":"calc(100vh - 56px)"}},fe={class:"col-lg-10 col-md-11"},ue={class:"row justify-content-center"},ge=["onClick","onKeyup"],he={class:"preview-content"},ve={class:"preview-title"},Ae={class:"preview-subtitle"},be={class:"project-info"},we={style:{color:"#1a2744"}},ye={class:"tech-tags mb-3"},Ce={key:1,class:"project-view"};function xe(o,t,d,p,a,n){return r(),i("div",null,[n.selectedProject?(r(),i("div",Ce,[e("mfp-button",{class:"back-button",variant:"secondary",onClick:t[0]||(t[0]=s=>n.selectedProject=null)},[...t[3]||(t[3]=[e("i",{class:"fas fa-arrow-left me-2"},null,-1),C("Back to Data Analysis ",-1)])]),(r(),x(k(a.projectComponents[n.selectedProject])))])):(r(),i("div",de,[e("div",pe,[e("div",fe,[t[2]||(t[2]=e("h2",{class:"text-center mb-4",style:{color:"#1a2744","font-weight":"bold"}},"Data Analysis",-1)),e("div",ue,[(r(!0),i(A,null,b(a.projects,s=>(r(),i("div",{class:"col-lg-4 col-md-6 mb-4",key:s.key},[e("div",{class:"project-card",onClick:c=>n.selectedProject=s.key,tabindex:"0",role:"button",onKeyup:w(c=>n.selectedProject=s.key,["enter"])},[e("div",{class:y(["project-preview",s.previewClass])},[e("div",he,[e("span",ve,l(s.title),1),e("span",Ae,l(s.subtitle),1)])],2),e("div",be,[e("h4",we,l(s.title),1),e("p",null,l(s.description),1),e("div",ye,[(r(!0),i(A,null,b(s.tags,c=>(r(),i("mfp-badge",{key:c},l(c),1))),128))]),t[1]||(t[1]=e("span",{class:"btn btn-primary",style:{"background-color":"#1a2744","border-color":"#1a2744"}}," View Project ",-1))])],40,ge)]))),128))])])])]))])}const Re=m(me,[["render",xe],["__scopeId","data-v-02a4ead9"]]);export{Re as default};
