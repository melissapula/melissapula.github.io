const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/about-BqbclI7o.js","assets/about-BdgtuSV_.css","assets/resume-BEkYNUqP.js","assets/resume-BCGVtwTf.css","assets/portfolio-BG57WeFj.js","assets/portfolio-CYuw-CN_.css","assets/pythonCode-CdX8cZal.js","assets/python-BPHgqrB5.js","assets/python-xUpPpDMJ.css","assets/pythonCode-BFhx52Yj.css","assets/dataAnalysis-gFHohRdn.js","assets/dataAnalysis-DzNbxj_w.css","assets/contact-CB1Qxau2.js","assets/contact-CklT2K0j.css","assets/notFound-BaAEFLhA.js","assets/notFound-B5RUNLfv.css"])))=>i.map(i=>d[i]);
 ...
 */function Ao(e){return(t,n)=>{const{slot:r,selector:s}=e??{},o="slot"+(r?`[name=${r}]`:":not([name])");return Rl(t,n,{get(){var l;const i=(l=this.renderRoot)==null?void 0:l.querySelector(o),a=(i==null?void 0:i.assignedElements(e))??[];return s===void 0?a:a.filter(u=>u.matches(s))}})}}var rn=function(e,t,n,r){var s=arguments.length,o=s<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,i;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")o=Reflect.decorate(e,t,n,r);else for(var a=e.length-1;a>=0;a--)(i=e[a])&&(o=(s<3?i(o):s>3?i(t,n,o):i(t,n))||o);return s>3&&o&&Object.defineProperty(t,n,o),o},yn;let jr=(yn=class extends _e{constructor(){super(),this.exclusive=!1,this._onToggle=t=>{if(!this.exclusive)return;const n=t.target;if(n.open)for(const r of this._items)r!==n&&r.open&&(r.open=!1)},this.addEventListener("mfp-accordion-toggle",this._onToggle)}render(){return de`<slot></slot>`}},yn.styles=Le`
    ...
    `,Qt.formAssociated=!0,Qt);qe([F({reflect:!0})],De.prototype,"size",void 0);qe([F()],De.prototype,"type",void 0);qe([F()],De.prototype,"value",void 0);qe([F()],De.prototype,"name",void 0);qe([F()],De.prototype,"label",void 0);qe([F()],De.prototype,"placeholder",void 0);qe([F()],De.prototype,"hint",void 0);qe([F()],De.prototype,"error",void 0);qe([F({type:Boolean,reflect:!0})],De.prototype,"disabled",void 0);qe([F({type:Boolean,reflect:!0})],De.prototype,"readonly",void 0);qe([F({type:Boolean,reflect:!0})],De.prototype,"required",void 0);De=qe([Be("mfp-input")],De);var We=function(e,t,n,r){var s=arguments.length,o=s<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,i;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")o=Reflect.decorate(e,t,n,r);else for(var a=e.length-1;a>=0;a--)(i=e[a])&&(o=(s<3?i(o):s>3?i(t,n,o):i(t,n))||o);return s>3&&o&&Object.defineProperty(t,n,o),o},Cn;let hr=(Cn=class extends _e{constructor(){super(...arguments),this.sticky=!1,this.variant="default",this._onSlotChange=()=>this._syncOrientation()}_syncOrientation(){for(const t of this._items)t.orientation="horizontal"}firstUpdated(){this._syncOrientation()}render(){return de`
    ...
    `,Cn);We([F({type:Boolean,reflect:!0})],hr.prototype,"sticky",void 0);We([F({reflect:!0})],hr.prototype,"variant",void 0);We([Ao({selector:"mfp-nav-item"})],hr.prototype,"_items",void 0);hr=We([Be("mfp-nav-bar")],hr);var Sn;let Hr=(Sn=class extends _e{constructor(){super(...arguments),this.variant="default",this._onItemsSlotChange=()=>this._syncOrientation(),this._onNamedSlotChange=t=>{const n=t.target,r=n.parentElement;if(!r)return;const s=n.assignedNodes({flatten:!0}).length>0;r.toggleAttribute("data-empty",!s)}}_syncOrientation(){for(const t of this._items)t.orientation="vertical"}firstUpdated(){this._syncOrientation()}render(){return de`
...
`,Tl="mfp-theme",Ri="mfp-active-theme",Vr={blue:{label:"Blue (default)",css:td},warm:{label:"Warm",css:nd},orange:{label:"Orange",css:rd},earth:{label:"Earth",css:sd},portfolio:{label:"Portfolio (navy)",css:od}},id="portfolio";function Pl(){const e=localStorage.getItem(Tl);return e&&e in Vr?e:id}function Nl(e){if(!(e in Vr))return;let t=document.getElementById(Ri);t||(t=document.createElement("style"),t.id=Ri,document.head.appendChild(t)),t.textContent=Vr[e].css,localStorage.setItem(Tl,e)}function ad(){Nl(Pl())}const Il=(e,t)=>{const n=e.__vccOpts||e;for(const[r,s]of t)n[r]=s;return n},ld={name:"App",data(){return{currentYear:new Date().getFullYear(),themes:Vr,activeTheme:Pl(),navLinks:[{to:"/",label:"Home"},{to:"/about",label:"About"},{to:"/resume",label:"Resume"},{to:"/portfolio",label:"Projects"},{to:"/python",label:"Python"},{to:"/data",label:"Data Analysis"}]}},methods:{go(e){this.$route.path!==e&&this.$router.push(e)},onThemeChange(e){var n;const t=(n=e.detail)==null?void 0:n.value;t&&(Nl(t),this.activeTheme=t)},syncNavHeight(){var t;const e=(t=this.$refs.navBar)==null?void 0:t.offsetHeight;e&&document.documentElement.style.setProperty("--site-nav-height",`${e}px`)}},mounted(){this.syncNavHeight(),this._navResizeObserver=new ResizeObserver(()=>this.syncNavHeight()),this._navResizeObserver.observe(this.$refs.navBar)},beforeUnmount(){var e;(e=this._navResizeObserver)==null||e.disconnect()}},cd={class:"h-100 m-0 p-0"},fd={ref:"navBar",sticky:"",variant:"brand"},ud=["active","onClick"],dd={slot:"actions",class:"navbar-actions"},hd=["active"],pd=["value"],md=["value"],gd={variant:"brand"},vd={class:"footer-copy"};function bd(e,t,n,r,s,o){const i=Ms("router-link"),a=Ms("router-view");return at(),fn("div",cd,[me("mfp-nav-bar",fd,[ge(i,{slot:"brand",to:"/",class:"brand-link"},{default:bt(()=>[...t[2]||(t[2]=[pl("Melissa Freundschuh-Pula",-1)])]),_:1}),(at(!0),fn(Me,null,Uo(s.navLinks,l=>(at(),fn("mfp-nav-item",{key:l.to,active:e.$route.path===l.to,onClick:u=>o.go(l.to)},wr(l.label),9,ud))),128)),me("div",dd,[me("mfp-nav-item",{active:e.$route.path==="/contact",onClick:t[0]||(t[0]=l=>o.go("/contact"))},"Contact",8,hd),me("mfp-select",{class:"theme-switcher",size:"sm","aria-label":"Theme",value:s.activeTheme,onChange:t[1]||(t[1]=(...l)=>o.onThemeChange&&o.onThemeChange(...l))},[(at(!0),fn(Me,null,Uo(s.themes,(l,u)=>(at(),fn("option",{key:u,value:u},wr(l.label),9,md))),128))],40,pd)])],512),ge(a,null,{default:bt(({Component:l})=>[ge(ou,{name:"fade",mode:"out-in"},{default:bt(()=>[(at(),Fs(If,null,{fallback:bt(()=>[...t[3]||(t[3]=[me("div",{class:"route-loading"},[me("mfp-spinner",{size:"lg",label:"Loading page"})],-1)])]),default:bt(()=>[(at(),Fs(of(l)))]),_:2},1024))]),_:2},1024)]),_:1}),me("mfp-footer",gd,[me("span",vd,"© "+wr(s.currentYear)+" Melissa Freundschuh-Pula",1),t[4]||(t[4]=Hf('<div class="footer-links"><a href="https://github.com/melissapula" target="_blank" rel="noopener noreferrer" aria-label="GitHub"><i class="fab fa-github"></i></a><a href="https://www.linkedin.com/in/melissa-pula-833748172" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn"><i class="fab fa-linkedin"></i></a><a href="mailto:melissa_m_24@yahoo.com" aria-label="Email"><i class="fas fa-envelope"></i></a></div>',1))])])}const yd=Il(ld,[["render",bd]]),_d="modulepreload",xd=function(e){return"/"+e},Oi={},Ut=function(t,n,r){let s=Promise.resolve();if(n&&n.length>0){document.getElementsByTagName("link");const i=document.querySelector("meta[property=csp-nonce]"),a=(i==null?void 0:i.nonce)||(i==null?void 0:i.getAttribute("nonce"));s=Promise.allSettled(n.map(l=>{if(l=xd(l),l in Oi)return;Oi[l]=!0;const u=l.endsWith(".css"),f=u?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${l}"]${f}`))return;const c=document.createElement("link");if(c.rel=u?"stylesheet":_d,u||(c.as="script"),c.crossOrigin="",c.href=l,a&&c.setAttribute("nonce",a),document.head.appendChild(c),u)return new Promise((p,m)=>{c.addEventListener("load",p),c.addEventListener("error",()=>m(new Error(`Unable to preload CSS for ${l}`)))})}))}function o(i){const a=new Event("vite:preloadError",{cancelable:!0});if(a.payload=i,window.dispatchEvent(a),!a.defaultPrevented)throw i}return s.then(i=>{for(const a of i||[])a.status==="rejected"&&o(a.reason);return t().catch(o)})};/*!
 * vue-router v4.6.4
 * (c) 2025 Eduardo San Martin Morote
 * @license MIT
 */const dn=typeof document<"u";function kl(e){return typeof e=="object"||"displayName"in e||"props"in e||"__vccOpts"in e}function wd(e){return e.__esModule||e[Symbol.toStringTag]==="Module"||e.default&&kl(e.default)}const ne=Object.assign;function Es(e,t){const n={};for(const r in t){const s=t[r];n[r]=Xe(s)?s.map(e):e(s)}return n}const er=()=>{},Xe=Array.isArray;function Ti(e,t){const n={};for(const r in e)n[r]=r in t?t[r]:e[r];return n}const Ml=/#/g,Ed=/&/g,Ad=/\//g,Cd=/=/g,Sd=/\?/g,zl=/\+/g,$d=/%5B/g,Rd=/%5D/g,Dl=/%5E/g,Od=/%60/g,Ll=/%7B/g,Td=/%7C/g,Bl=/%7D/g,Pd=/%20/g;function $o(e){return e==null?"":encodeURI(""+e).replace(Td,"|").replace($d,"[").replace(Rd,"]")}function Nd(e){return $o(e).replace(Ll,"{").replace(Bl,"}").replace(Dl,"^")}function Ws(e){return $o(e).replace(zl,"%2B").replace(Pd,"+").replace(Ml,"%23").replace(Ed,"%26").replace(Od,"`").replace(Ll,"{").replace(Bl,"}").replace(Dl,"^")}function Id(e){return Ws(e).replace(Cd,"%3D")}function kd(e){return $o(e).replace(Ml,"%23").replace(Sd,"%3F")}function Md(e){return kd(e).replace(Ad,"%2F")}function pr(e){if(e==null)return null;try{return decodeURIComponent(""+e)}catch{}return""+e}const zd=/\/$/,Dd=e=>e.replace(zd,"");function As(e,t,n="/"){let r,s={},o="",i="";const a=t.indexOf("#");let l=t.indexOf("?");return l=a>=0&&l>a?-1:l,l>=0&&(r=t.slice(0,l),o=t.slice(l,a>0?a:t.length),s=e(o.slice(1))),a>=0&&(r=r||t.slice(0,a),i=t.slice(a,t.length)),r=Fd(r??t,n),{fullPath:r+o+i,path:r,query:s,hash:pr(i)}}function Ld(e,t){const n=t.query?e(t.query):"";return t.path+(n&&"?")+n+(t.hash||"")}function Pi(e,t){return!t||!e.toLowerCase().startsWith(t.toLowerCase())?e:e.slice(t.length)||"/"}function Bd(e,t,n){const r=t.matched.length-1,s=n.matched.length-1;return r>-1&&r===s&&kn(t.matched[r],n.matched[s])&&jl(t.params,n.params)&&e(t.query)===e(n.query)&&t.hash===n.hash}function kn(e,t){return(e.aliasOf||e)===(t.aliasOf||t)}function jl(e,t){if(Object.keys(e).length!==Object.keys(t).length)return!1;for(var n in e)if(!jd(e[n],t[n]))return!1;return!0}function jd(e,t){return Xe(e)?Ni(e,t):Xe(t)?Ni(t,e):(e==null?void 0:e.valueOf())===(t==null?void 0:t.valueOf())}function Ni(e,t){return Xe(t)?e.length===t.length&&e.every((n,r)=>n===t[r]):e.length===1&&e[0]===t}function Fd(e,t){if(e.startsWith("/"))return e;if(!e)return t;const n=t.split("/"),r=e.split("/"),s=r[r.length-1];(s===".."||s===".")&&r.push("");let o=n.length-1,i,a;for(i=0;i<r.length;i++)if(a=r[i],a!==".")if(a==="..")o>1&&o--;else break;return n.slice(0,o).join("/")+"/"+r.slice(i).join("/")}const St={path:"/",name:void 0,params:{},query:{},hash:"",fullPath:"/",matched:[],meta:{},redirectedFrom:void 0};let Ks=function(e){return e.pop="pop",e.push="push",e}({}),Cs=function(e){return e.back="back",e.forward="forward",e.unknown="",e}({});function Hd(e){if(!e)if(dn){const t=document.querySelector("base");e=t&&t.getAttribute("href")||"/",e=e.replace(/^\w+:\/\/[^\/]+/,"")}else e="/";return e[0]!=="/"&&e[0]!=="#"&&(e="/"+e),Dd(e)}const Ud=/^[^#]+#/;function Vd(e,t){return e.replace(Ud,"#")+t}function Gd(e,t){const n=document.documentElement.getBoundingClientRect(),r=e.getBoundingClientRect();return{behavior:t.behavior,left:r.left-n.left-(t.left||0),top:r.top-n.top-(t.top||0)}}const os=()=>({left:window.scrollX,top:window.scrollY});function qd(e){let t;if("el"in e){const n=e.el,r=typeof n=="string"&&n.startsWith("#"),s=typeof n=="string"?r?document.getElementById(n.slice(1)):document.querySelector(n):n;if(!s)return;t=Gd(s,e)}else t=e;"scrollBehavior"in document.documentElement.style?window.scrollTo(t):window.scrollTo(t.left!=null?t.left:window.scrollX,t.top!=null?t.top:window.scrollY)}function Ii(e,t){return(history.state?history.state.position-t:-1)+e}const Ys=new Map;function Wd(e,t){Ys.set(e,t)}function Kd(e){const t=Ys.get(e);return Ys.delete(e),t}function Yd(e){return typeof e=="string"||e&&typeof e=="object"}function Fl(e){return typeof e=="string"||typeof e=="symbol"}let he=function(e){return e[e.MATCHER_NOT_FOUND=1]="MATCHER_NOT_FOUND",e[e.NAVIGATION_GUARD_REDIRECT=2]="NAVIGATION_GUARD_REDIRECT",e[e.NAVIGATION_ABORTED=4]="NAVIGATION_ABORTED",e[e.NAVIGATION_CANCELLED=8]="NAVIGATION_CANCELLED",e[e.NAVIGATION_DUPLICATED=16]="NAVIGATION_DUPLICATED",e}({});const Hl=Symbol("");he.MATCHER_NOT_FOUND+"",he.NAVIGATION_GUARD_REDIRECT+"",he.NAVIGATION_ABORTED+"",he.NAVIGATION_CANCELLED+"",he.NAVIGATION_DUPLICATED+"";function Mn(e,t){return ne(new Error,{type:e,[Hl]:!0},t)}function ht(e,t){return e instanceof Error&&Hl in e&&(t==null||!!(e.type&t))}const Jd=["params","query","hash"];function Qd(e){if(typeof e=="string")return e;if(e.path!=null)return e.path;const t={};for(const n of Jd)n in e&&(t[n]=e[n]);return JSON.stringify(t,null,2)}function Zd(e){const t={};if(e===""||e==="?")return t;const n=(e[0]==="?"?e.slice(1):e).split("&");for(let r=0;r<n.length;++r){const s=n[r].replace(zl," "),o=s.indexOf("="),i=pr(o<0?s:s.slice(0,o)),a=o<0?null:pr(s.slice(o+1));if(i in t){let l=t[i];Xe(l)||(l=t[i]=[l]),l.push(a)}else t[i]=a}return t}function ki(e){let t="";for(let n in e){const r=e[n];if(n=Id(n),r==null){r!==void 0&&(t+=(t.length?"&":"")+n);continue}(Xe(r)?r.map(s=>s&&Ws(s)):[r&&Ws(r)]).forEach(s=>{s!==void 0&&(t+=(t.length?"&":"")+n,s!=null&&(t+="="+s))})}return t}function Xd(e){const t={};for(const n in e){const r=e[n];r!==void 0&&(t[n]=Xe(r)?r.map(s=>s==null?null:""+s):r==null?r:""+r)}return t}const eh=Symbol(""),Mi=Symbol(""),Ro=Symbol(""),Ul=Symbol(""),Js=Symbol("");function Un(){let e=[];function t(r){return e.push(r),()=>{const s=e.indexOf(r);s>-1&&e.splice(s,1)}}function n(){e=[]}return{add:t,list:()=>e.slice(),reset:n}}function Tt(e,t,n,r,s,o=i=>i()){const i=r&&(r.enterCallbacks[s]=r.enterCallbacks[s]||[]);return()=>new Promise((a,l)=>{const u=p=>{p===!1?l(Mn(he.NAVIGATION_ABORTED,{from:n,to:t})):p instanceof Error?l(p):Yd(p)?l(Mn(he.NAVIGATION_GUARD_REDIRECT,{from:t,to:p})):(i&&r.enterCallbacks[s]===i&&typeof p=="function"&&i.push(p),a())},f=o(()=>e.call(r&&r.instances[s],t,n,u));let c=Promise.resolve(f);e.length<3&&(c=c.then(u)),c.catch(p=>l(p))})}function Ss(e,t,n,r,s=o=>o()){const o=[];for(const i of e)for(const a in i.components){let l=i.components[a];if(!(t!=="beforeRouteEnter"&&!i.instances[a]))if(kl(l)){const u=(l.__vccOpts||l)[t];u&&o.push(Tt(u,n,r,i,a,s))}else{let u=l();o.push(()=>u.then(f=>{if(!f)throw new Error(`Couldn't resolve component "${a}" at "${i.path}"`);const c=wd(f)?f.default:f;i.mods[a]=f,i.components[a]=c;const p=(c.__vccOpts||c)[t];return p&&Tt(p,n,r,i,a,s)()}))}}return o}function th(e,t){const n=[],r=[],s=[],o=Math.max(t.matched.length,e.matched.length);for(let i=0;i<o;i++){const a=t.matched[i];a&&(e.matched.find(u=>kn(u,a))?r.push(a):n.push(a));const l=e.matched[i];l&&(t.matched.find(u=>kn(u,l))||s.push(l))}return[n,r,s]}/*!
 * vue-router v4.6.4
 * (c) 2025 Eduardo San Martin Morote
 * @license MIT
 */let nh=()=>location.protocol+"//"+location.host;function Vl(e,t){const{pathname:n,search:r,hash:s}=t,o=e.indexOf("#");if(o>-1){let i=s.includes(e.slice(o))?e.slice(o).length:1,a=s.slice(i);return a[0]!=="/"&&(a="/"+a),Pi(a,"")}return Pi(n,e)+r+s}function rh(e,t,n,r){let s=[],o=[],i=null;const a=({state:p})=>{const m=Vl(e,location),x=n.value,C=t.value;let H=0;if(p){if(n.value=m,t.value=p,i&&i===x){i=null;return}H=C?p.position-C.position:0}else r(m);s.forEach(N=>{N(n.value,x,{delta:H,type:Ks.pop,direction:H?H>0?Cs.forward:Cs.back:Cs.unknown})})};function l(){i=n.value}function u(p){s.push(p);const m=()=>{const x=s.indexOf(p);x>-1&&s.splice(x,1)};return o.push(m),m}function f(){if(document.visibilityState==="hidden"){const{history:p}=window;if(!p.state)return;p.replaceState(ne({},p.state,{scroll:os()}),"")}}function c(){for(const p of o)p();o=[],window.removeEventListener("popstate",a),window.removeEventListener("pagehide",f),document.removeEventListener("visibilitychange",f)}return window.addEventListener("popstate",a),window.addEventListener("pagehide",f),document.addEventListener("visibilitychange",f),{pauseListeners:l,listen:u,destroy:c}}function zi(e,t,n,r=!1,s=!1){return{back:e,current:t,forward:n,replaced:r,position:window.history.length,scroll:s?os():null}}function sh(e){const{history:t,location:n}=window,r={value:Vl(e,n)},s={value:t.state};s.value||o(r.value,{back:null,current:r.value,forward:null,position:t.length-1,replaced:!0,scroll:null},!0);function o(l,u,f){const c=e.indexOf("#"),p=c>-1?(n.host&&document.querySelector("base")?e:e.slice(c))+l:nh()+e+l;try{t[f?"replaceState":"pushState"](u,"",p),s.value=u}catch(m){console.error(m),n[f?"replace":"assign"](p)}}function i(l,u){o(l,ne({},t.state,zi(s.value.back,l,s.value.forward,!0),u,{position:s.value.position}),!0),r.value=l}function a(l,u){const f=ne({},s.value,t.state,{forward:l,scroll:os()});o(f.current,f,!0),o(l,ne({},zi(r.value,l,null),{position:f.position+1},u),!1),r.value=l}return{location:r,state:s,push:a,replace:i}}function oh(e){e=Hd(e);const t=sh(e),n=rh(e,t.state,t.location,t.replace);function r(o,i=!0){i||n.pauseListeners(),history.go(o)}const s=ne({location:"",base:e,go:r,createHref:Vd.bind(null,e)},t,n);return Object.defineProperty(s,"location",{enumerable:!0,get:()=>t.location.value}),Object.defineProperty(s,"state",{enumerable:!0,get:()=>t.state.value}),s}function ih(e){return e=location.host?e||location.pathname+location.search:"",e.includes("#")||(e+="#"),oh(e)}let qt=function(e){return e[e.Static=0]="Static",e[e.Param=1]="Param",e[e.Group=2]="Group",e}({});var ve=function(e){return e[e.Static=0]="Static",e[e.Param=1]="Param",e[e.ParamRegExp=2]="ParamRegExp",e[e.ParamRegExpEnd=3]="ParamRegExpEnd",e[e.EscapeNext=4]="EscapeNext",e}(ve||{});const ah={type:qt.Static,value:""},lh=/[a-zA-Z0-9_]/;function ch(e){if(!e)return[[]];if(e==="/")return[[ah]];if(!e.startsWith("/"))throw new Error(`Invalid path "${e}"`);function t(m){throw new Error(`ERR (${n})/"${u}": ${m}`)}let n=ve.Static,r=n;const s=[];let o;function i(){o&&s.push(o),o=[]}let a=0,l,u="",f="";function c(){u&&(n===ve.Static?o.push({type:qt.Static,value:u}):n===ve.Param||n===ve.ParamRegExp||n===ve.ParamRegExpEnd?(o.length>1&&(l==="*"||l==="+")&&t(`A repeatable param (${u}) must be alone in its segment. eg: '/:ids+.`),o.push({type:qt.Param,value:u,regexp:f,repeatable:l==="*"||l==="+",optional:l==="*"||l==="?"})):t("Invalid state to consume buffer"),u="")}function p(){u+=l}for(;a<e.length;){if(l=e[a++],l==="\\"&&n!==ve.ParamRegExp){r=n,n=ve.EscapeNext;continue}switch(n){case ve.Static:l==="/"?(u&&c(),i()):l===":"?(c(),n=ve.Param):p();break;case ve.EscapeNext:p(),n=r;break;case ve.Param:l==="("?n=ve.ParamRegExp:lh.test(l)?p():(c(),n=ve.Static,l!=="*"&&l!=="?"&&l!=="+"&&a--);break;case ve.ParamRegExp:l===")"?f[f.length-1]=="\\"?f=f.slice(0,-1)+l:n=ve.ParamRegExpEnd:f+=l;break;case ve.ParamRegExpEnd:c(),n=ve.Static,l!=="*"&&l!=="?"&&l!=="+"&&a--,f="";break;default:t("Unknown state");break}}return n===ve.ParamRegExp&&t(`Unfinished custom RegExp for param "${u}"`),c(),i(),s}const Di="[^/]+?",fh={sensitive:!1,strict:!1,start:!0,end:!0};var Se=function(e){return e[e._multiplier=10]="_multiplier",e[e.Root=90]="Root",e[e.Segment=40]="Segment",e[e.SubSegment=30]="SubSegment",e[e.Static=40]="Static",e[e.Dynamic=20]="Dynamic",e[e.BonusCustomRegExp=10]="BonusCustomRegExp",e[e.BonusWildcard=-50]="BonusWildcard",e[e.BonusRepeatable=-20]="BonusRepeatable",e[e.BonusOptional=-8]="BonusOptional",e[e.BonusStrict=.7000000000000001]="BonusStrict",e[e.BonusCaseSensitive=.25]="BonusCaseSensitive",e}(Se||{});const uh=/[.+*?^${}()[\]/\\]/g;function dh(e,t){const n=ne({},fh,t),r=[];let s=n.start?"^":"";const o=[];for(const u of e){const f=u.length?[]:[Se.Root];n.strict&&!u.length&&(s+="/");for(let c=0;c<u.length;c++){const p=u[c];let m=Se.Segment+(n.sensitive?Se.BonusCaseSensitive:0);if(p.type===qt.Static)c||(s+="/"),s+=p.value.replace(uh,"\\$&"),m+=Se.Static;else if(p.type===qt.Param){const{value:x,repeatable:C,optional:H,regexp:N}=p;o.push({name:x,repeatable:C,optional:H});const O=N||Di;if(O!==Di){m+=Se.BonusCustomRegExp;try{`${O}`}catch(I){throw new Error(`Invalid custom RegExp for param "${x}" (${O}): `+I.message)}}let M=C?`((?:${O})(?:/(?:${O}))*)`:`(${O})`;c||(M=H&&u.length<2?`(?:/${M})`:"/"+M),H&&(M+="?"),s+=M,m+=Se.Dynamic,H&&(m+=Se.BonusOptional),C&&(m+=Se.BonusRepeatable),O===".*"&&(m+=Se.BonusWildcard)}f.push(m)}r.push(f)}if(n.strict&&n.end){const u=r.length-1;r[u][r[u].length-1]+=Se.BonusStrict}n.strict||(s+="/?"),n.end?s+="$":n.strict&&!s.endsWith("/")&&(s+="(?:/|$)");const i=new RegExp(s,n.sensitive?"":"i");function a(u){const f=u.match(i),c={};if(!f)return null;for(let p=1;p<f.length;p++){const m=f[p]||"",x=o[p-1];c[x.name]=m&&x.repeatable?m.split("/"):m}return c}function l(u){let f="",c=!1;for(const p of e){(!c||!f.endsWith("/"))&&(f+="/"),c=!1;for(const m of p)if(m.type===qt.Static)f+=m.value;else if(m.type===qt.Param){const{value:x,repeatable:C,optional:H}=m,N=x in u?u[x]:"";if(Xe(N)&&!C)throw new Error(`Provided param "${x}" is an array but it is not repeatable (* or + modifiers)`);const O=Xe(N)?N.join("/"):N;if(!O)if(H)p.length<2&&(f.endsWith("/")?f=f.slice(0,-1):c=!0);else throw new Error(`Missing required param "${x}"`);f+=O}}return f||"/"}return{re:i,score:r,keys:o,parse:a,stringify:l}}function hh(e,t){let n=0;for(;n<e.length&&n<t.length;){const r=t[n]-e[n];if(r)return r;n++}return e.length<t.length?e.length===1&&e[0]===Se.Static+Se.Segment?-1:1:e.length>t.length?t.length===1&&t[0]===Se.Static+Se.Segment?1:-1:0}function Gl(e,t){let n=0;const r=e.score,s=t.score;for(;n<r.length&&n<s.length;){const o=hh(r[n],s[n]);if(o)return o;n++}if(Math.abs(s.length-r.length)===1){if(Li(r))return 1;if(Li(s))return-1}return s.length-r.length}function Li(e){const t=e[e.length-1];return e.length>0&&t[t.length-1]<0}const ph={strict:!1,end:!0,sensitive:!1};function mh(e,t,n){const r=dh(ch(e.path),n),s=ne(r,{record:e,parent:t,children:[],alias:[]});return t&&!s.record.aliasOf==!t.record.aliasOf&&t.children.push(s),s}function gh(e,t){const n=[],r=new Map;t=Ti(ph,t);function s(c){return r.get(c)}function o(c,p,m){const x=!m,C=ji(c);C.aliasOf=m&&m.record;const H=Ti(t,c),N=[C];if("alias"in c){const I=typeof c.alias=="string"?[c.alias]:c.alias;for(const T of I)N.push(ji(ne({},C,{components:m?m.record.components:C.components,path:T,aliasOf:m?m.record:C})))}let O,M;for(const I of N){const{path:T}=I;if(p&&T[0]!=="/"){const D=p.record.path,W=D[D.length-1]==="/"?"":"/";I.path=p.record.path+(T&&W+T)}if(O=mh(I,p,H),m?m.alias.push(O):(M=M||O,M!==O&&M.alias.push(O),x&&c.name&&!Fi(O)&&i(c.name)),ql(O)&&l(O),C.children){const D=C.children;for(let W=0;W<D.length;W++)o(D[W],O,m&&m.children[W])}m=m||O}return M?()=>{i(M)}:er}function i(c){if(Fl(c)){const p=r.get(c);p&&(r.delete(c),n.splice(n.indexOf(p),1),p.children.forEach(i),p.alias.forEach(i))}else{const p=n.indexOf(c);p>-1&&(n.splice(p,1),c.record.name&&r.delete(c.record.name),c.children.forEach(i),c.alias.forEach(i))}}function a(){return n}function l(c){const p=yh(c,n);n.splice(p,0,c),c.record.name&&!Fi(c)&&r.set(c.record.name,c)}function u(c,p){let m,x={},C,H;if("name"in c&&c.name){if(m=r.get(c.name),!m)throw Mn(he.MATCHER_NOT_FOUND,{location:c});H=m.record.name,x=ne(Bi(p.params,m.keys.filter(M=>!M.optional).concat(m.parent?m.parent.keys.filter(M=>M.optional):[]).map(M=>M.name)),c.params&&Bi(c.params,m.keys.map(M=>M.name))),C=m.stringify(x)}else if(c.path!=null)C=c.path,m=n.find(M=>M.re.test(C)),m&&(x=m.parse(C),H=m.record.name);else{if(m=p.name?r.get(p.name):n.find(M=>M.re.test(p.path)),!m)throw Mn(he.MATCHER_NOT_FOUND,{location:c,currentLocation:p});H=m.record.name,x=ne({},p.params,c.params),C=m.stringify(x)}const N=[];let O=m;for(;O;)N.unshift(O.record),O=O.parent;return{name:H,path:C,params:x,matched:N,meta:bh(N)}}e.forEach(c=>o(c));function f(){n.length=0,r.clear()}return{addRoute:o,resolve:u,removeRoute:i,clearRoutes:f,getRoutes:a,getRecordMatcher:s}}function Bi(e,t){const n={};for(const r of t)r in e&&(n[r]=e[r]);return n}function ji(e){const t={path:e.path,redirect:e.redirect,name:e.name,meta:e.meta||{},aliasOf:e.aliasOf,beforeEnter:e.beforeEnter,props:vh(e),children:e.children||[],instances:{},leaveGuards:new Set,updateGuards:new Set,enterCallbacks:{},components:"components"in e?e.components||null:e.component&&{default:e.component}};return Object.defineProperty(t,"mods",{value:{}}),t}function vh(e){const t={},n=e.props||!1;if("component"in e)t.default=n;else for(const r in e.components)t[r]=typeof n=="object"?n[r]:n;return t}function Fi(e){for(;e;){if(e.record.aliasOf)return!0;e=e.parent}return!1}function bh(e){return e.reduce((t,n)=>ne(t,n.meta),{})}function yh(e,t){let n=0,r=t.length;for(;n!==r;){const o=n+r>>1;Gl(e,t[o])<0?r=o:n=o+1}const s=_h(e);return s&&(r=t.lastIndexOf(s,r-1)),r}function _h(e){let t=e;for(;t=t.parent;)if(ql(t)&&Gl(e,t)===0)return t}function ql({record:e}){return!!(e.name||e.components&&Object.keys(e.components).length||e.redirect)}function Hi(e){const t=yt(Ro),n=yt(Ul),r=Ye(()=>{const l=mn(e.to);return t.resolve(l)}),s=Ye(()=>{const{matched:l}=r.value,{length:u}=l,f=l[u-1],c=n.matched;if(!f||!c.length)return-1;const p=c.findIndex(kn.bind(null,f));if(p>-1)return p;const m=Ui(l[u-2]);return u>1&&Ui(f)===m&&c[c.length-1].path!==m?c.findIndex(kn.bind(null,l[u-2])):p}),o=Ye(()=>s.value>-1&&Ch(n.params,r.value.params)),i=Ye(()=>s.value>-1&&s.value===n.matched.length-1&&jl(n.params,r.value.params));function a(l={}){if(Ah(l)){const u=t[mn(e.replace)?"replace":"push"](mn(e.to)).catch(er);return e.viewTransition&&typeof document<"u"&&"startViewTransition"in document&&document.startViewTransition(()=>u),u}return Promise.resolve()}return{route:r,href:Ye(()=>r.value.href),isActive:o,isExactActive:i,navigate:a}}function xh(e){return e.length===1?e[0]:e}const wh=Ba({name:"RouterLink",compatConfig:{MODE:3},props:{to:{type:[String,Object],required:!0},replace:Boolean,activeClass:String,exactActiveClass:String,custom:Boolean,ariaCurrentValue:{type:String,default:"page"},viewTransition:Boolean},useLink:Hi,setup(e,{slots:t}){const n=Qr(Hi(e)),{options:r}=yt(Ro),s=Ye(()=>({[Vi(e.activeClass,r.linkActiveClass,"router-link-active")]:n.isActive,[Vi(e.exactActiveClass,r.linkExactActiveClass,"router-link-exact-active")]:n.isExactActive}));return()=>{const o=t.default&&xh(t.default(n));return e.custom?o:bo("a",{"aria-current":n.isExactActive?e.ariaCurrentValue:null,href:n.href,onClick:n.navigate,class:s.value},o)}}}),Eh=wh;function Ah(e){if(!(e.metaKey||e.altKey||e.ctrlKey||e.shiftKey)&&!e.defaultPrevented&&!(e.button!==void 0&&e.button!==0)){if(e.currentTarget&&e.currentTarget.getAttribute){const t=e.currentTarget.getAttribute("target");if(/\b_blank\b/i.test(t))return}return e.preventDefault&&e.preventDefault(),!0}}function Ch(e,t){for(const n in t){const r=t[n],s=e[n];if(typeof r=="string"){if(r!==s)return!1}else if(!Xe(s)||s.length!==r.length||r.some((o,i)=>o.valueOf()!==s[i].valueOf()))return!1}return!0}function Ui(e){return e?e.aliasOf?e.aliasOf.path:e.path:""}const Vi=(e,t,n)=>e??t??n,Sh=Ba({name:"RouterView",inheritAttrs:!1,props:{name:{type:String,default:"default"},route:Object},compatConfig:{MODE:3},setup(e,{attrs:t,slots:n}){const r=yt(Js),s=Ye(()=>e.route||r.value),o=yt(Mi,0),i=Ye(()=>{let u=mn(o);const{matched:f}=s.value;let c;for(;(c=f[u])&&!c.components;)u++;return u}),a=Ye(()=>s.value.matched[i.value]);Er(Mi,Ye(()=>i.value+1)),Er(eh,a),Er(Js,s);const l=Nc();return Ar(()=>[l.value,a.value,e.name],([u,f,c],[p,m,x])=>{f&&(f.instances[c]=u,m&&m!==f&&u&&u===p&&(f.leaveGuards.size||(f.leaveGuards=m.leaveGuards),f.updateGuards.size||(f.updateGuards=m.updateGuards))),u&&f&&(!m||!kn(f,m)||!p)&&(f.enterCallbacks[c]||[]).forEach(C=>C(u))},{flush:"post"}),()=>{const u=s.value,f=e.name,c=a.value,p=c&&c.components[f];if(!p)return Gi(n.default,{Component:p,route:u});const m=c.props[f],x=m?m===!0?u.params:typeof m=="function"?m(u):m:null,H=bo(p,ne({},x,t,{onVnodeUnmounted:N=>{N.component.isUnmounted&&(c.instances[f]=null)},ref:l}));return Gi(n.default,{Component:H,route:u})||H}}});function Gi(e,t){if(!e)return null;const n=e(t);return n.length===1?n[0]:n}const $h=Sh;function Rh(e){const t=gh(e.routes,e),n=e.parseQuery||Zd,r=e.stringifyQuery||ki,s=e.history,o=Un(),i=Un(),a=Un(),l=Ic(St);let u=St;dn&&e.scrollBehavior&&"scrollRestoration"in history&&(history.scrollRestoration="manual");const f=Es.bind(null,y=>""+y),c=Es.bind(null,Md),p=Es.bind(null,pr);function m(y,k){let R,L;return Fl(y)?(R=t.getRecordMatcher(y),L=k):L=y,t.addRoute(L,R)}function x(y){const k=t.getRecordMatcher(y);k&&t.removeRoute(k)}function C(){return t.getRoutes().map(y=>y.record)}function H(y){return!!t.getRecordMatcher(y)}function N(y,k){if(k=ne({},k||l.value),typeof y=="string"){const g=As(n,y,k.path),v=t.resolve({path:g.path},k),_=s.createHref(g.fullPath);return ne(g,v,{params:p(v.params),hash:pr(g.hash),redirectedFrom:void 0,href:_})}let R;if(y.path!=null)R=ne({},y,{path:As(n,y.path,k.path).path});else{const g=ne({},y.params);for(const v in g)g[v]==null&&delete g[v];R=ne({},y,{params:c(g)}),k.params=c(k.params)}const L=t.resolve(R,k),Q=y.hash||"";L.params=f(p(L.params));const d=Ld(r,ne({},y,{hash:Nd(Q),path:L.path})),h=s.createHref(d);return ne({fullPath:d,hash:Q,query:r===ki?Xd(y.query):y.query||{}},L,{redirectedFrom:void 0,href:h})}function O(y){return typeof y=="string"?As(n,y,l.value.path):ne({},y)}function M(y,k){if(u!==y)return Mn(he.NAVIGATION_CANCELLED,{from:k,to:y})}function I(y){return W(y)}function T(y){return I(ne(O(y),{replace:!0}))}function D(y,k){const R=y.matched[y.matched.length-1];if(R&&R.redirect){const{redirect:L}=R;let Q=typeof L=="function"?L(y,k):L;return typeof Q=="string"&&(Q=Q.includes("?")||Q.includes("#")?Q=O(Q):{path:Q},Q.params={}),ne({query:y.query,hash:y.hash,params:Q.path!=null?{}:y.params},Q)}}function W(y,k){const R=u=N(y),L=l.value,Q=y.state,d=y.force,h=y.replace===!0,g=D(R,L);if(g)return W(ne(O(g),{state:typeof g=="object"?ne({},Q,g.state):Q,force:d,replace:h}),k||R);const v=R;v.redirectedFrom=k;let _;return!d&&Bd(r,L,R)&&(_=Mn(he.NAVIGATION_DUPLICATED,{to:v,from:L}),tt(L,L,!0,!1)),(_?Promise.resolve(_):G(v,L)).catch(b=>ht(b)?ht(b,he.NAVIGATION_GUARD_REDIRECT)?b:At(b):X(b,v,L)).then(b=>{if(b){if(ht(b,he.NAVIGATION_GUARD_REDIRECT))return W(ne({replace:h},O(b.to),{state:typeof b.to=="object"?ne({},Q,b.to.state):Q,force:d}),k||v)}else b=S(v,L,!0,h,Q);return Y(v,L,b),b})}function te(y,k){const R=M(y,k);return R?Promise.reject(R):Promise.resolve()}function z(y){const k=an.values().next().value;return k&&typeof k.runWithContext=="function"?k.runWithContext(y):y()}function G(y,k){let R;const[L,Q,d]=th(y,k);R=Ss(L.reverse(),"beforeRouteLeave",y,k);for(const g of L)g.leaveGuards.forEach(v=>{R.push(Tt(v,y,k))});const h=te.bind(null,y,k);return R.push(h),Fe(R).then(()=>{R=[];for(const g of o.list())R.push(Tt(g,y,k));return R.push(h),Fe(R)}).then(()=>{R=Ss(Q,"beforeRouteUpdate",y,k);for(const g of Q)g.updateGuards.forEach(v=>{R.push(Tt(v,y,k))});return R.push(h),Fe(R)}).then(()=>{R=[];for(const g of d)if(g.beforeEnter)if(Xe(g.beforeEnter))for(const v of g.beforeEnter)R.push(Tt(v,y,k));else R.push(Tt(g.beforeEnter,y,k));return R.push(h),Fe(R)}).then(()=>(y.matched.forEach(g=>g.enterCallbacks={}),R=Ss(d,"beforeRouteEnter",y,k,z),R.push(h),Fe(R))).then(()=>{R=[];for(const g of i.list())R.push(Tt(g,y,k));return R.push(h),Fe(R)}).catch(g=>ht(g,he.NAVIGATION_CANCELLED)?g:Promise.reject(g))}function Y(y,k,R){a.list().forEach(L=>z(()=>L(y,k,R)))}function S(y,k,R,L,Q){const d=M(y,k);if(d)return d;const h=k===St,g=dn?history.state:{};R&&(L||h?s.replace(y.fullPath,ne({scroll:h&&g&&g.scroll},Q)):s.push(y.fullPath,Q)),l.value=y,tt(y,k,R,h),At()}let K;function ue(){K||(K=s.listen((y,k,R)=>{if(!Dt.listening)return;const L=N(y),Q=D(L,Dt.currentRoute.value);if(Q){W(ne(Q,{replace:!0,force:!0}),L).catch(er);return}u=L;const d=l.value;dn&&Wd(Ii(d.fullPath,R.delta),os()),G(L,d).catch(h=>ht(h,he.NAVIGATION_ABORTED|he.NAVIGATION_CANCELLED)?h:ht(h,he.NAVIGATION_GUARD_REDIRECT)?(W(ne(O(h.to),{force:!0}),L).then(g=>{ht(g,he.NAVIGATION_ABORTED|he.NAVIGATION_DUPLICATED)&&!R.delta&&R.type===Ks.pop&&s.go(-1,!1)}).catch(er),Promise.reject()):(R.delta&&s.go(-R.delta,!1),X(h,L,d))).then(h=>{h=h||S(L,d,!1),h&&(R.delta&&!ht(h,he.NAVIGATION_CANCELLED)?s.go(-R.delta,!1):R.type===Ks.pop&&ht(h,he.NAVIGATION_ABORTED|he.NAVIGATION_DUPLICATED)&&s.go(-1,!1)),Y(L,d,h)}).catch(er)}))}let xe=Un(),ie=Un(),J;function X(y,k,R){At(y);const L=ie.list();return L.length?L.forEach(Q=>Q(y,k,R)):console.error(y),Promise.reject(y)}function ft(){return J&&l.value!==St?Promise.resolve():new Promise((y,k)=>{xe.add([y,k])})}function At(y){return J||(J=!y,ue(),xe.list().forEach(([k,R])=>y?R(y):k()),xe.reset()),y}function tt(y,k,R,L){const{scrollBehavior:Q}=e;if(!dn||!Q)return Promise.resolve();const d=!R&&Kd(Ii(y.fullPath,0))||(L||!R)&&history.state&&history.state.scroll||null;return Pr().then(()=>Q(y,k,d)).then(h=>h&&qd(h)).catch(h=>X(h,y,k))}const Re=y=>s.go(y);let on;const an=new Set,Dt={currentRoute:l,listening:!0,addRoute:m,removeRoute:x,clearRoutes:t.clearRoutes,hasRoute:H,getRoutes:C,resolve:N,options:e,push:I,replace:T,go:Re,back:()=>Re(-1),forward:()=>Re(1),beforeEach:o.add,beforeResolve:i.add,afterEach:a.add,onError:ie.add,isReady:ft,install(y){y.component("RouterLink",Eh),y.component("RouterView",$h),y.config.globalProperties.$router=Dt,Object.defineProperty(y.config.globalProperties,"$route",{enumerable:!0,get:()=>mn(l)}),dn&&!on&&l.value===St&&(on=!0,I(s.location).catch(L=>{}));const k={};for(const L in St)Object.defineProperty(k,L,{get:()=>l.value[L],enumerable:!0});y.provide(Ro,Dt),y.provide(Ul,Ea(k)),y.provide(Js,l);const R=y.unmount;an.add(y),y.unmount=function(){an.delete(y),an.size<1&&(u=St,K&&K(),K=null,l.value=St,on=!1,J=!1),R()}}};function Fe(y){return y.reduce((k,R)=>k.then(()=>z(R)),Promise.resolve())}return Dt}const Oh="/assets/Family-TJUrK4ZO.jpeg",Th={name:"Home"},Ph={class:"container-fluid mt-0 pt-0"},Nh={class:"row align-items-center justify-content-center",style:{"min-height":"calc(100vh - var(--site-nav-height, 56px))","background-color":"#f8f9fa",overflow:"hidden"}},Ih={class:"col-12 col-md-6 col-lg-5 ps-md-5 mt-4 mt-md-0"},kh={class:"mt-4 hero-actions"},Mh=["onClick"],zh=["onClick"],Dh=["onClick"];function Lh(e,t,n,r,s,o){const i=Ms("router-link");return at(),fn("div",Ph,[me("div",Nh,[t[3]||(t[3]=me("div",{class:"col-12 col-md-6 col-lg-5 text-center"},[me("img",{src:Oh,class:"img-fluid rounded shadow",style:{"max-height":"calc(100vh - 120px)","object-fit":"contain"},alt:"Melissa with her wife and four kids"})],-1)),me("div",Ih,[t[0]||(t[0]=me("h1",{class:"hero-name",style:{color:"#1a2744"}},"Melissa Freundschuh-Pula",-1)),t[1]||(t[1]=me("h4",{class:"hero-title mt-2",style:{color:"#1a2744"}},"Full-Stack Software Engineer",-1)),t[2]||(t[2]=me("p",{class:"hero-intro mt-3",style:{color:"#2c3e50"}}," Six-plus years building enterprise web apps by day and live products on the side. Wife, mom of four, Marine Corps veteran, and a believer that the best software is shipped, not just shipped on paper. ",-1)),me("div",kh,[ge(i,{to:"/portfolio",custom:""},{default:bt(({navigate:a})=>[me("mfp-button",{variant:"primary",onClick:a},"See Projects",8,Mh)]),_:1}),ge(i,{to:"/resume",custom:""},{default:bt(({navigate:a})=>[me("mfp-button",{variant:"secondary",onClick:a},"Resume",8,zh)]),_:1}),ge(i,{to:"/contact",custom:""},{default:bt(({navigate:a})=>[me("mfp-button",{variant:"secondary",onClick:a},"Get In Touch",8,Dh)]),_:1})])])])])}const Bh=Il(Th,[["render",Lh],["__scopeId","data-v-cb4b7212"]]),jh=[{path:"/",name:"Home",component:Bh,meta:{title:"Home"}},{path:"/about",name:"About",component:()=>Ut(()=>import("./about-BqbclI7o.js"),__vite__mapDeps([0,1])),meta:{title:"About"}},{path:"/resume",name:"Resume",component:()=>Ut(()=>import("./resume-BEkYNUqP.js"),__vite__mapDeps([2,3])),meta:{title:"Resume"}},{path:"/portfolio",name:"Portfolio",component:()=>Ut(()=>import("./portfolio-BG57WeFj.js"),__vite__mapDeps([4,5])),meta:{title:"Projects"}},{path:"/python",name:"PythonCode",component:()=>Ut(()=>import("./pythonCode-CdX8cZal.js"),__vite__mapDeps([6,7,8,9])),meta:{title:"Python"}},{path:"/data",name:"DataAnalysis",component:()=>Ut(()=>import("./dataAnalysis-gFHohRdn.js"),__vite__mapDeps([10,7,8,11])),meta:{title:"Data Analysis"}},{path:"/contact",name:"Contact",component:()=>Ut(()=>import("./contact-CB1Qxau2.js"),__vite__mapDeps([12,13])),meta:{title:"Contact"}},{path:"/:pathMatch(.*)*",name:"NotFound",component:()=>Ut(()=>import("./notFound-BaAEFLhA.js"),__vite__mapDeps([14,15])),meta:{title:"Page Not Found"}}],qi="Melissa Freundschuh-Pula",Oo=Rh({history:ih(),routes:jh});Oo.afterEach(e=>{var n;const t=(n=e.meta)==null?void 0:n.title;document.title=t?`${t} | ${qi}`:qi});const Fh=(e,t={})=>new Promise((n,r)=>{if(typeof document>"u")return;const s=document.head||document.getElementsByTagName("head")[0],o=document.createElement("script");if(o.async=!0,o.src=e,o.defer=t.defer,t.preconnectOrigin){const i=document.createElement("link");i.href=t.preconnectOrigin,i.rel="preconnect",s.appendChild(i)}s.appendChild(o),o.onload=n,o.onerror=r}),Qs=e=>typeof e=="function",$s=e=>e&&typeof e=="object"&&!Array.isArray(e),Zs=(e,...t)=>{if(!t.length)return e;const n=t.shift();if(!(!$s(e)||!$s(n))){for(const r in n)$s(n[r])?(e[r]||Object.assign(e,{[r]:{}}),Zs(e[r],n[r])):Object.assign(e,{[r]:n[r]});return Zs(e,...t)}},is=()=>!(typeof window>"u"||typeof document>"u"),Wi=(e,t=!0)=>{},Hh=(e={})=>(Wi('Missing "appName" property inside the plugin options.',e.app_name==null),Wi('Missing "name" property in the route.',e.screen_name==null),e);function Uh(e="",t=""){const n=e.split("/"),r=t.split("/");return n[0]===""&&t[t.length-1]==="/"&&n.shift(),r.join("/")+n.join("/")}const Vh=()=>({bootstrap:!0,onReady:null,onError:null,onBeforeTrack:null,onAfterTrack:null,pageTrackerTemplate:null,customResourceURL:"https://www.googletagmanager.com/gtag/js",customPreconnectOrigin:"https://www.googletagmanager.com",deferScriptLoad:!1,pageTrackerExcludedRoutes:[],pageTrackerEnabled:!0,enabled:!0,disableScriptLoad:!1,pageTrackerScreenviewEnabled:!1,appName:null,pageTrackerUseFullPath:!1,pageTrackerPrependBase:!0,pageTrackerSkipSamePath:!0,globalDataLayerName:"dataLayer",globalObjectName:"gtag",defaultGroupName:"default",includes:null,config:{id:null,params:{send_page_view:!1}}});let Wl={};const Gh=(e={})=>{const t=Vh();Wl=Zs(t,e)},je=()=>Wl,nn=(...e)=>{const{globalObjectName:t}=je();!is()||typeof window[t]>"u"||window[t](...e)},To=(...e)=>{const{config:t,includes:n}=je();if(nn("config",t.id,...e),Array.isArray(n))for(const r of n)nn("config",r.id,...e)},Ki=(e,t)=>{is()&&(window[`ga-disable-${e}`]=t)},Kl=(e=!0)=>{const{config:t,includes:n}=je();if(Ki(t.id,e),Array.isArray(n))for(const r of n)Ki(r.id,e)},Yl=()=>{Kl(!0)},qh=()=>{Kl(!1)},sn=(e,t={})=>{const{includes:n,defaultGroupName:r}=je();t.send_to==null&&Array.isArray(n)&&n.length&&(t.send_to=n.map(s=>s.id).concat(r)),nn("event",e,t)};let Jl;const Wh=e=>{Jl=e},Po=()=>Jl,Ql=e=>{if(!is())return;let t;if(typeof e=="string")t={page_path:e};else if(e.path||e.fullPath){const{pageTrackerUseFullPath:n,pageTrackerPrependBase:r}=je(),s=Po(),o=s==null?void 0:s.options.base,i=n?e.fullPath:e.path;t={...e.name&&{page_title:e.name},page_path:r?Uh(i,o):i}}else t=e;t.page_location==null&&(t.page_location=window.location.href),t.send_page_view==null&&(t.send_page_view=!0),sn("page_view",t)},Zl=e=>{const{appName:t}=je();if(!e)return;let n;typeof e=="string"?n={screen_name:e}:n=e,n.app_name=n.app_name||t,sn("screen_view",n)},Kh=(...e)=>{sn("exception",...e)},Yh=e=>{To("linker",e)},Jh=e=>{sn("timing_complete",e)},Qh=(...e)=>{nn("set",...e)},Zh=(...e)=>{sn("refund",...e)},Xh=e=>{sn("purchase",e)},ep=e=>{To({custom_map:e})},tp=Object.freeze(Object.defineProperty({__proto__:null,config:To,customMap:ep,event:sn,exception:Kh,linker:Yh,optIn:qh,optOut:Yl,pageview:Ql,purchase:Xh,query:nn,refund:Zh,screenview:Zl,set:Qh,time:Jh},Symbol.toStringTag,{value:"Module"})),np=e=>{e.config.globalProperties.$gtag=tp},Yi=e=>({send_page_view:!1,...e}),Xl=()=>{const{config:e,includes:t}=je();if(nn("config",e.id,Yi(e.params)),Array.isArray(t))for(const n of t)nn("config",n.id,Yi(n.params))},Ji=(e={},t={})=>{const{appName:n,pageTrackerTemplate:r,pageTrackerScreenviewEnabled:s,pageTrackerSkipSamePath:o}=je();if(o&&e.path===t.path)return;let i=e;if(Qs(r)?i=r(e,t):s&&(i=Hh({app_name:n,screen_name:e.name})),s){Zl(i);return}Ql(i)},Qi=e=>{const{pageTrackerExcludedRoutes:t}=je();return t.includes(e.path)||t.includes(e.name)},rp=()=>{const{onBeforeTrack:e,onAfterTrack:t}=je(),n=Po();n.isReady().then(()=>{Pr().then(()=>{const{currentRoute:r}=n;Xl(),!Qi(r.value)&&Ji(r.value)}),n.afterEach((r,s)=>{Pr().then(()=>{Qi(r)||(Qs(e)&&e(r,s),Ji(r,s),Qs(t)&&t(r,s))})})})},sp=()=>{if(!is())return;const{enabled:e,globalObjectName:t,globalDataLayerName:n}=je();return window[t]==null&&(window[n]=window[n]||[],window[t]=function(){window[n].push(arguments)}),window[t]("js",new Date),e||Yl(),window[t]},op=()=>{const{onReady:e,onError:t,globalObjectName:n,globalDataLayerName:r,config:s,customResourceURL:o,customPreconnectOrigin:i,deferScriptLoad:a,pageTrackerEnabled:l,disableScriptLoad:u}=je(),f=!!(l&&Po());if(sp(),f?rp():Xl(),!u)return Fh(`${o}?id=${s.id}&l=${r}`,{preconnectOrigin:i,defer:a}).then(()=>{e&&e(window[n])}).catch(c=>(t&&t(c),c))},ip=(e,t,n)=>{np(e),Gh(t),Wh(n),je().bootstrap&&op()};ad();const No=Ru(yd);No.use(Oo);No.use(ip,{config:{id:"G-ZP2LCLVZ2X",params:{send_page_view:!1}}},Oo);No.mount("#app");export{ml as A,Pr as B,Ye as C,Pc as D,Me as F,Il as _,me as a,Hf as b,fn as c,ge as d,Uo as e,Ha as f,Ua as g,lp as h,pl as i,Nc as j,ap as k,fp as l,Fs as m,so as n,at as o,of as p,Ba as q,Ms as r,Ar as s,wr as t,Uf as u,cp as v,bt as w,mn as x,ro as y,Ic as z};
